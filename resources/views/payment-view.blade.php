                                ...
                                <div class="card-body pt-2 h--70px">
                                    <form action="{{ route('pay-ssl',request()->getQueryString()) }}" method="POST" class="needs-validation" id="ssl-form">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{my_asset('assets/admin/img/sslcomz.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                                ...
                                <div class="card-body pt-1 h--70px">
                                    ...
                                    <!-- Note that the amount is in paise = 50 INR -->
                                        ...
                                        <script src="https://checkout.razorpay.com/v1/checkout.js"
                                                ...
                                                data-image="{{my_asset('storage/app/public/business/'.\App\Models\BusinessSetting::where(['key'=>'logo'])->first()->value)}}"
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{my_asset('assets/admin/img/razorpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pb-0 pt-1 h--70px">
                                    <form class="needs-validation" method="POST" id="payment-form"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="100"
                                                 src="{{my_asset('assets/admin/img/paypal.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body py-0 h-70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button" id="checkout-button">
                                        <img width="100" src="{{my_asset('assets/admin/img/stripe.png')}}"/>
                                    </button>
                            ...
                            <div class="card">
                                <div class="card-body py-0 h--70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{my_asset('assets/admin/img/paystack.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-1 h--70px">
                                    ...
                                    <button class="btn btn-block click-if-alone" type="button"
                                        ...
                                        <img width="100"
                                             src="{{my_asset('assets/admin/img/senangpay.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-2 h--70px">
                                    <form method="POST" action="{{ route('flutterwave_pay',request()->getQueryString()) }}">
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="200"
                                                 src="{{my_asset('assets/admin/img/fluterwave.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body pt-2 h--70px">
                                    <a class="btn btn-block click-if-alone" href="{{route('mercadopago.index',request()->getQueryString())}}">
                                        <img width="150"
                                                src="{{my_asset('assets/admin/img/MercadoPago_(Horizontal).svg')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h--100px">
                                    <form class="needs-validation" method="POST" id="payment-form-paymob"
                                        ...
                                        <button class="btn btn-block click-if-alone" type="submit">
                                            <img width="150"
                                                src="{{my_asset('assets/admin/img/paymob.png')}}"/>
                                        </button>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body h--100px">
                                    <button class="btn btn-block click-if-alone" id="bKash_button" onclick="BkashPayment()">
                                        <img width="100" src="{{my_asset('assets/admin/img/bkash.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h--100px">
                                    <button class="btn btn-block click-if-alone mt--n-11" onclick="location.href='{{route('paytabs-payment')}}'">
                                        <img width="150" src="{{my_asset('assets/admin/img/paytabs.png')}}"/>
                                    </button>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card">
                                <div class="card-body h--100px">
                                    <a class="btn btn-block click-if-alone" href="{{route('paytm-payment',request()->getQueryString())}}">
                                        <img class="initial--40" src="{{my_asset('assets/admin/img/paytm.png')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-body h--100px">
                                    <a class="btn btn-block click-if-alone" href="{{route('liqpay-payment',request()->getQueryString())}}">
                                        <img class="initial--41"
                                            src="{{my_asset('assets/admin/img/liqpay4.png')}}"/>
                                    </a>
                                </div>
                            </div>
                        </div>
...
<script src="{{my_asset('assets/admin')}}/js/sweet_alert.js"></script>
<script src="{{my_asset('assets/admin')}}/js/toastr.js"></script>
<script src="{{my_asset('assets/admin')}}/js/bootstrap.min.js"></script>
