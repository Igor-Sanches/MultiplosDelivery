                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        <label class="input-label"
                                            for="identity_type">{{ translate('messages.identity') }}
                                            {{ translate('messages.type') }}</label>
                                        <select name="identity_type" class="form-control __form-control">
                                            <option value="rg">{{ translate('messages.rg') }}</option>
                                            <option value="cnh">{{ translate('messages.driving_cnh') }}</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="identity_number" class="form-control __form-control"
                                            value="{{ old('identity_number') }}" placeholder="{{ translate('messages.Ex:') }} 88787887676" required>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" name="tel" id="phone" placeholder="{{ translate('messages.Ex:') }} (xx) xxxxx-xxxx"
