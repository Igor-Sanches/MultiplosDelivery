        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/notification.png')}}" class="w--26" alt="">
                </span>
                <span>
                            ...
                            <div class="h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--vertical" id="viewer"
                                        src="{{my_asset('storage/app/public/notification')}}/{{$notification['image']}}"  onerror="src='{{my_asset('assets/admin/img/900x400/img1.jpg')}}'" alt="image"/>
                                </center>
    ...
    <script>
        ...
        <script>
            $('#reset_btn').click(function(){
                ...
                $('#viewer').attr('src', "{{my_asset('storage/app/public/notification')}}/{{$notification['image']}}");
            })
        </script>
@endpush
