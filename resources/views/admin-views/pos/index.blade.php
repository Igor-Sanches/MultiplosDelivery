                    ...
                    <div class="card h-100">
                                    ...
                                    <div class="col-sm-6 col-12">
                                        <form id="search-form" class="search-form">
                                            ...
                                            <div class="input-group input--group">
                                                <input id="datatableSearch" type="search" value="{{$keyword?$keyword:''}}" name="search" class="form-control h--45px" placeholder="{{translate('messages.ex_search_here')}}" aria-label="{{translate('messages.search_here')}}" disabled>
                        ...
                        <div class="card-body d-flex flex-column" id="items">
                            ...
                            <div class="search--no-found">
                                <img src="{{my_asset('assets/admin/img/search-icon.png')}}" alt="img">
                                <p>
