            ...
            @if($order['order_type']!='take_away')
                    ...
                    @if($order->delivery_man)
                        <div class="media align-items-center" href="javascript:">
                            <div class="avatar avatar-circle mr-3">
                                <img
                                    class="avatar-img img--75" onerror="this.src='{{my_asset('assets/admin/img/160x160/img1.jpg')}}'"
                ...
                <div class="card mb-2">
                    ...
                    <!-- Body -->
                        ...
                        <div class="card-body">
                        @if($order->customer)
                            <a class="media align-items-center" href="{{ route('admin.customer.view', ['index', $order->customer['id']]) }}">
                                <div class="avatar avatar-circle mr-3">
                                    <img
