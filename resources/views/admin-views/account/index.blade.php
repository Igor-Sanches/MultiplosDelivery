    ...
    <div class="page-header">
        <h1 class="page-header-title">
            <span class="page-header-icon">
                <img src="{{my_asset('assets/admin/img/collect-cash.png')}}" class="w--22" alt="">
            </span>
            <span>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control" type="text" name="method" id="method" required maxlength="191" placeholder="{{translate('messages.ex_Card')}}">
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group mb-0">
                            ...
                            <input class="form-control" type="number" min=".01" step="0.01" name="amount" id="amount" max="999999999999.99" placeholder="{{translate('messages.ex_1000')}}">
                        </div>
                    </div>
                    <div class="col-lg-12">
