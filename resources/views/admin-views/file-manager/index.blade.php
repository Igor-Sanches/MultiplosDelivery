            ...
            <div class="col-md">
                <h1 class="page-header-title">
                    <span class="page-header-icon">
                        <img src="{{my_asset('assets/admin/img/folder-logo.png')}}" class="w--26" alt="">
                    </span>
                    <span>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-auto">
                            ...
                            <a class="btn p-0 btn--folder"  href="{{route('admin.file-manager.index', base64_encode($file['path']))}}">
                                <img class="img-thumbnail border-0 p-0" src="{{my_asset('assets/admin/img/folder.png')}}" alt="">
                                <p>{{Str::limit($file['name'],10)}}</p>
                            </a>
                            @elseif($file['type']=='file')
                            <!-- <a class="btn" href="{{my_asset('storage/app/'.$file['path'])}}" download> -->
                            <button class="btn w-100"  data-toggle="modal" data-target="#imagemodal{{$key}}" title="{{$file['name']}}">
                                <div class="gallary-card">
                                    <img src="{{my_asset('storage/app/'.$file['path'])}}" alt="{{$file['name']}}" class="w-100">
                                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="{{my_asset('storage/app/'.$file['path'])}}" class="w-100" >
                                        </div>
