        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/edit.png')}}" class="w--26" alt="">
                </span>
                <span>
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    <div class="card-body pt-3">
                                        <h5 class="text-capitalize mb-3">@lang('messages.banner_clickable')</h5>
                                        <div class="d-flex flex-wrap p-0">
                                            <label class="form-check form--check mr-2 mr-md-4">
                                                <input class="form-check-input clickable" type="radio" name="clickable"
                                                       onclick="clickableFunc(true)"
                                                       {{$banner->clickable ? 'checked' : ''}}
                                                       value="yes">
                                                <span class="form-check-label">{{translate('messages.active')}}</span>
                                            </label>
                                            <label class="form-check form--check">
                                                <input class="form-check-input clickable" type="radio" name="clickable"
                                                       onclick="clickableFunc(false)"
                                                       {{$banner->clickable ? '' : 'checked'}}
                                                       value="no">
                                    ...
                                    <div class="form-group" id="layout_banner_type" {{$banner->clickable ? '' : 'hidden'}}>
                                    ...
                                    <div class="form-group mb-0" id="store_wise" {{$banner->clickable ? '' : 'hidden'}}>
                                    ...
                                    <div class="form-group mb-0" id="item_wise" {{$banner->clickable ? '' : 'hidden'}}>
                                    ...
                                    <div class="form-group mb-0" id="default" {{$banner->clickable ? '' : 'hidden'}}>
                                ...
                                <div class="col-lg-6">
                                    <div class="h-100 d-flex flex-column">
                                        ...
                                        <center class="py-3 my-auto">
                                            <img class="img--vertical" id="viewer" onerror="this.src='{{my_asset('assets/admin/img/900x400/img1.jpg')}}'" src="{{my_asset('storage/app/public/banner')}}/{{$banner['image']}}" alt="campaign image"/>
                                        </center>
...
@push('script_2')
    <script>
        ...
        const layout_banner_type = document.getElementById('layout_banner_type')
        const store_wise = document.getElementById('store_wise')
        const item_wise = document.getElementById('item_wise')
        const _default = document.getElementById('default')

        function clickableFunc(clickable){
            if(clickable){
                layout_banner_type.removeAttribute('hidden')
                store_wise.removeAttribute('hidden')
                item_wise.removeAttribute('hidden')
                _default.removeAttribute('hidden')
            }else{
                layout_banner_type.setAttribute('hidden', '')
                store_wise.setAttribute('hidden', '')
                item_wise.setAttribute('hidden', '')
                _default.setAttribute('hidden', '')
            }
        }
        ...
        $('#banner_form').on('submit', function (e) {
            ...
            <script>
                $('#reset_btn').click(function(){
                    ...
                    // $('#viewer').attr('src','{{my_asset('storage/app/public/banner')}}/{{$banner['image']}}');
