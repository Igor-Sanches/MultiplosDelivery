        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/banner.png')}}" class="w--26" alt="">
                </span>
                <span>
                        ...
                        <form action="{{route('admin.banner.store')}}" method="post" id="banner_form">
                            ...
                            <div class="row g-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group" id="layout_banner_type">
                                    ...
                                    <div class="h-100 d-flex flex-column">
                                        ...
                                        <center class="py-3 my-auto">
                                            <img class="img--vertical" id="viewer"
                                                src="{{my_asset('assets/admin/img/900x400/img1.jpg')}}" alt="campaign image"/>
                                        </center>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="media align-items-center">
                                            <img class="img--ratio-3 w-auto h--50px rounded mr-2" src="{{my_asset('storage/app/public/banner')}}/{{$banner['image']}}"
                                                 onerror="this.src='{{my_asset('/assets/admin/img/900x400/img1.jpg')}}'" alt="{{$banner->name}} image">
    ...
    <script>
        ...
        <script>
            $('#reset_btn').click(function(){
                ...
                $('#viewer').attr('src','{{my_asset('assets/admin/img/900x400/img1.jpg')}}');
            })
        </script>
@endpush
