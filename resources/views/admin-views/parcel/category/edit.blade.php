                        ...
                        <div class="col-lg-6">
                            <div class="h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--130" id="viewer" src="{{my_asset('storage/app/public/parcel_category')}}/{{$parcel_category['image']}}" alt="" onerror='this.src="{{my_asset('/assets/admin/img/400x400/img2.jpg')}}"' />
                                </center>
    ...
    <script>
        ...
        <script>
            $('#reset_btn').click(function(){
                ...
                $('#viewer').attr('src', "{{my_asset('storage/app/public/parcel_category')}}/{{$parcel_category['image']}}");
            })
        </script>
@endpush
