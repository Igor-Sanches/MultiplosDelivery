                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title m-0 d-flex align-items-center">
                                <img class="mr-2 align-self-start w--20" src="{{my_asset('assets/admin/img/resturant.png')}}" alt="instructions">
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <center class="py-4 my-auto">
                                            <img class="img--120" id="viewer"
                                                src="{{my_asset('storage/app/public/store').'/'.$store->logo}}" alt="{{$store->name}}" onerror='this.src="{{my_asset('assets/admin/img/400x400/img2.jpg')}}"'/>
                                        </center>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        ...
                                        <center class="py-4 my-auto">
                                            ...
                                            onerror="this.src='{{my_asset('assets/admin/img/900x400/img1.jpg')}}'"
                                            src="{{my_asset('storage/app/public/store/cover/'.$store->cover_photo)}}" alt="Product thumbnail"/>
                                        </center>
                                        <div class="custom-file">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-group">
                                        <label class="input-label" for="choice_zones">{{translate('messages.zone')}}<span
                                                class="input-label-secondary" title="{{translate('messages.select_zone_for_map')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.select_zone_for_map')}}"></span></label>
                                    ...
                                    <div class="form-group">
                                        <label class="input-label" for="exampleFormControlInput1">{{translate('messages.latitude')}}<span
                                                class="input-label-secondary" title="{{translate('messages.store_lat_lng_warning')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_lat_lng_warning')}}"></span></label>
                                        <input type="text"
...
<script>
    ...
    <script>
        $('#reset_btn').click(function(){
            $('#viewer').attr('src', "{{my_asset('storage/app/public/store').'/'.$store->logo}}");
            $('#customFileEg1').val(null);
            $('#coverImageViewer').attr('src', "{{my_asset('storage/app/public/store/cover/'.$store->cover_photo)}}");
