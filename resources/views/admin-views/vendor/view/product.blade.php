            ...
            <div class="resturant-card-navbar px-xl-4 justify-content-evenly">
                <div class="order-info-item">
                    <div class="order-info-icon icon-sm">
                        <img src="{{my_asset('/assets/admin/img/all.png')}}" alt="public">
                    </div>
                ...
                <div class="order-info-item">
                    <div class="order-info-icon icon-sm">
                <img src="{{my_asset('/assets/admin/img/active.png')}}" alt="public">
                    </div>
                ...
                <div class="order-info-item">
                    <div class="order-info-icon icon-sm">
                <img src="{{my_asset('/assets/admin/img/inactive.png')}}" alt="public">
                    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="media align-items-center" href="{{route('admin.item.view',[$food['id']])}}">
                                    <img class="avatar avatar-lg mr-3" src="{{my_asset('storage/app/public/product')}}/{{$food['image']}}"
                                            onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{$food->name}} image">
