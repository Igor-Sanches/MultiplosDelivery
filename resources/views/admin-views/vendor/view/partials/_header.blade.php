    ...
    <div class="page-header pb-0">
        ...
        <div class="js-nav-scroller hs-nav-scroller-horizontal">
            ...
            <ul class="nav nav-tabs page-header-tabs mb-2">
                ...
                <li class="nav-item">
                    <a class="nav-link {{request('tab')=='wallet'?'active':''}}" href="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'wallet'])}}"  aria-disabled="true">{{translate('messages.wallet_')}}</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{request('tab')=='invoices'?'active':''}}" href="{{route('admin.store.view', ['store'=>$store->id, 'tab'=> 'invoices'])}}"  aria-disabled="true">{{translate('messages.invoices')}}</a>
                </li>
                <li class="nav-item">
