    ...
    <div class="tab-content">
        <div class="tab-pane fade show active" id="vendor">
                ...
                <div class="card-header">
                    <h5 class="card-title">
                        <span class="card-header-icon">
                            <img class="w--22" src="{{my_asset('assets/admin/img/store.png')}}" alt="">
                        </span>
                    ...
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.manage_item_setup')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('By disabling this field, the store can`t manage items, which means the store web panel app won`t get the access for managing items')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.show_hide_food_menu')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.Show_Reviews_In_Store_Panel')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this field is active, the store panel & store app can see the customer`s review')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.show_hide_food_menu')}}"></span> </span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 text-capitalize">{{translate('messages.include_POS_in_store_panel')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this option is turned on, the store panel will get the
                                    Point of Sale (POS) option')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.pos_system_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.scheduled')}} {{translate('messages.order_option')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this status is turned on, the customer is able to place a scheduled
                                    order for this store')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.scheduled_order_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 text-capitalize">{{translate('messages.self_delivery')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('Quando esta opção está habilitada, as lojas precisam entregar os pedidos por conta própria ou por entregador próprio. As lojas também terão a opção de adicionar seu próprio entregador no painel da loja')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.self_delivery_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="delivery">
                                    <span class="pr-2">{{translate('messages.home_delivery')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.home_delivery_hint')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.home_delivery_hint')}}"></span></span>
                        ...
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2 text-capitalize">{{translate('messages.take_away')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{__('messages.take_away_hint')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.take_away_hint')}}"></span></span>
                        ...
                        {{-- <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <span class="pr-2">{{translate('messages.free_delivery')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{__('messages.free_delivery_toggle_hint')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{__('messages.free_delivery_toggle_hint')}}"></span></span>
                    ...
                    <div class="row g-3 mt-3">
                        <form action="{{route('admin.store.update-settings',[$store['id']])}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    <label class="input-label text-capitalize" for="maximum_delivery_time">{{translate('messages.minimum_processing_time')}}<span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.minimum_processing_time_warning')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.minimum_processing_time_warning')}}"></span></label>
                                ...
                                <div class="form-group col-sm-6 col-lg-4">
                                    ...
                                    <div class="form-group col-sm-6 col-lg-4">
                                        <div class="form-group">
                                            <label class="d-flex mb-1 justify-content-between switch toggle-switch-sm text-dark text-capitalize" for="no_commission_default">
                                                <span>{{translate('messages.admin_commission')}}(%) <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"></span></span>
                                                <input type="checkbox" class="toggle-switch-input" name="no_commission_default" id="no_commission_default" value="1" {{$store->no_commission_default ? 'checked' : ''}}>
                                                <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                            </label>
                                            <input type="number" id="comission" min="0" max="10000" step="0.01" name="comission" class="form-control" required value="{{$store->no_commission_default ? $store->comission : $commission_default->value}}" {{$store->no_commission_default?'':'readonly'}}>
                                        </div>
                                    </div>
                                    @php($cashback_default = \App\Models\BusinessSetting::query()->where('key', 'cashback_default')->first())
                                    <div class="form-group col-sm-6 col-lg-4">
                                        <div class="form-group">
                                            <label class="d-flex mb-1 justify-content-between switch toggle-switch-sm text-dark text-capitalize" for="no_cashback_default">
                                                <span>{{translate('messages.cashback_store')}}(%) <span class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.if_sales_cashback_store_disabled_system_default_will_be_applicable')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.if_sales_commission_disabled_system_default_will_be_applicable')}}"></span></span>
                                                <input type="checkbox" class="toggle-switch-input" name="no_cashback_default" id="no_cashback_default" value="1" {{$store->no_cashback_default ? 'checked' : ''}}>
                                                <span class="toggle-switch-label">
                                                <span class="toggle-switch-indicator"></span>
                                            </span>
                                            </label>
                                            <input type="number" id="cashback_store" min="0" max="10000" step="0.01" name="cashback_store" class="form-control" required value="{{$store->no_cashback_default ? $store->cashback_store : $cashback_default->value}}" {{$store->no_cashback_default?'':'readonly'}}>
                                        </div>
                                    </div>
                                    <div class="col-12">
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="card-title">
                        ...
                        <span>{{translate('messages.payment_offline')}}</span>
                    </h5>
                </div>
                <div class="card-body">
                   <div class="row g-3">
                       <div class="col-sm-6 col-lg-4">
                           <div class="form-group mb-0">
                               <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_offline">
                                   <span class="pr-2 text-capitalize">{{translate('messages.payment_cash')}}</span>
                                   <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.store.toggle-settings',[$store->id,$store->payment_offline?0:1, 'payment_offline'])}}'" id="payment_offline" {{$store->payment_offline?'checked':''}}>
                                   <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                               </label>
                       ...
                       <div class="col-sm-6 col-lg-4">
                           <div class="form-group mb-0">
                               <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_pix_offline">
                                   <span class="pr-2 text-capitalize">{{translate('messages.payment_pix_offline')}}</span>
                                   <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.store.toggle-settings',[$store->id,$store->payment_pix_offline?0:1, 'payment_pix_offline'])}}'" id="payment_pix_offline" {{$store->payment_pix_offline?'checked':''}}>
                                   <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                               </label>
                       ...
                       <div class="col-sm-6 col-lg-4">
                           <div class="form-group mb-0">
                               <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_credit_card_offline">
                                   <span class="pr-2 text-capitalize">{{translate('messages.payment_credit_card_offline')}}</span>
                                   <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.store.toggle-settings',[$store->id,$store->payment_credit_card_offline?0:1, 'payment_credit_card_offline'])}}'" id="payment_credit_card_offline" {{$store->payment_credit_card_offline?'checked':''}}>
                                   <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                               </label>
                       ...
                       <div class="col-sm-6 col-lg-4">
                           <div class="form-group mb-0">
                               <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_debit_card_offline">
                                   <span class="pr-2 text-capitalize">{{translate('messages.payment_debit_card_offline')}}</span>
                                   <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.store.toggle-settings',[$store->id,$store->payment_credit_card_offline?0:1, 'payment_debit_card_offline'])}}'" id="payment_debit_card_offline" {{$store->payment_debit_card_offline?'checked':''}}>
                                   <span class="toggle-switch-label">
                                        <span class="toggle-switch-indicator"></span>
                                    </span>
                               </label>
            ...
            <div class="card mt-3">
                <div class="card-header">
                    <h5 class="card-title">
                        <span class="card-header-icon"><i class="tio-motocycle"></i></span>
                        <span>{{translate('messages.radius_delivery')}}</span>
                    </h5>
                </div>
                <div class="card-body">
                    <form action="{{route('admin.store.update-setup-delivery-radius',[$store['id']])}}" method="post"
                        ...
                        <div class="row g-3">
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group mb-0">
                                    <label class="form-label text-capitalize"
                                           for="delivery_radius">{{ translate('messages.is_delivery_radius') }}</label>
                                    <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="is_delivery_radius">
                                        <span class="pr-2 text-capitalize">{{translate('messages.is_delivery_radius')}}:</span>
                                        <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('admin.store.toggle-settings',[$store->id,$store->is_delivery_radius?0:1, 'is_delivery_radius'])}}'" id="is_delivery_radius" {{$store->is_delivery_radius?'checked':''}}>
                                        <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                                    </label>
                            ...
                            <div class="col-sm-6 col-lg-4">
                                <div class="form-group mb-0">
                                    <label class="form-label text-capitalize"
                                           for="delivery_radius">{{ translate('messages.delivery_radius') }}</label>
                                    <input type="text" name="delivery_radius" class="form-control"
                                           id="delivery_radius"
                                           pattern="^\d*(\.\d{0,2})?$"
                                           value="{{ to_km($store->delivery_radius) }}"
...
@push('script_2')
    ...
    <script>
        $(document).on('ready', function () {
            ...
            @php($commission_default = \App\Models\BusinessSetting::query()->where('key', 'admin_commission')->first())
            $("#no_commission_default").on('change', function(){
                if($("#no_commission_default").is(':checked')){
                    $('#comission').removeAttr('readonly');
                    $('#comission').val('{{$store->comission}}');
               } else {
                    $('#comission').attr('readonly', true);
                    $('#comission').val('{{$commission_default->value}}');
                }
            });
            @php($cashback_default = \App\Models\BusinessSetting::query()->where('key', 'cashback_default')->first())
            $("#no_cashback_default").on('change', function(){
                if($("#no_cashback_default").is(':checked')){
                    $('#cashback_store').removeAttr('readonly');
                    $('#cashback_store').val('{{$store->cashback_store}}');
                } else {
                    $('#cashback_store').attr('readonly', true);
                    $('#cashback_store').val('{{$cashback_default->value}}');
                }
            });
