                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        ...
                                        <center class="py-4 my-auto">
                                            ...
                                            src="{{my_asset('assets/admin/img/100x100/1.png')}}" alt="{{translate('store_logo')}}"/>
                                        </center>
                                ...
                                <div class="col-sm-6 col-lg-4">
                                    <div class="d-flex flex-column">
                                        ...
                                        <center class="py-4 my-auto">
                                            ...
                                            src="{{my_asset('assets/admin/img/900x400/img1.jpg')}}" alt="Product thumbnail"/>
                                        </center>
                                        <div class="custom-file">
...
@push('script_2')
    ...
    <script src="{{my_asset('assets/admin/js/spartan-multi-image-picker.js')}}"></script>
    <script type="text/javascript">
        $(function () {
            $("#coba").spartanMultiImagePicker({
                ...
                maxFileSize: '',
                placeholderImage: {
                    image: '{{my_asset('assets/admin/img/400x400/img2.jpg')}}',
                    width: '100%'
                },
    ...
    <script>
        ...
        <script>
            $('#reset_btn').click(function(){
                $('#viewer').attr('src', "{{ my_asset('assets/admin/img/400x400/img2.jpg') }}");
                $('#customFileEg1').val(null);
                $('#coverImageViewer').attr('src', "{{ my_asset('assets/admin/img/900x400/img1.jpg') }}");
