        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/resturant.png')}}" class="w--20" alt="">
                </span>
                <span>
            ...
            <div class="card-body p-2">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        <a href="{{my_asset('assets/stores_bulk_format.xlsx')}}" download="" class="btn btn-dark">{{ translate('messages.Template with Existing Data') }}</a>
                        <a href="{{my_asset('assets/stores_bulk_format_nodata.xlsx')}}" download="" class="btn btn-dark">{{ translate('messages.Template without Data') }}</a>
                    </div>
                </div>
            </div>
        </div>
