        ...
        <div class="page-header">
            <h1 class="page-header-title text-break">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/delivery-man.png')}}" class="w--26" alt="">
                </span>
                            ...
                            <tr>
                                <td>
                                    @if ($review->customer)
                                        ...
                                        href="{{route('admin.customer.view',['index', $review['user_id']])}}">
                                            <div class="avatar avatar-circle">
                                                <img class="avatar-img" width="75" height="75"
                                                    onerror="this.src='{{my_asset('assets/admin/img/160x160/img1.jpg')}}'"
                                                    src="{{my_asset('storage/app/public/profile/'.$review->customer?$review->customer->image:'')}}"
                                                    alt="Image Description">
                                            </div>
                                            <div class="ml-3">
