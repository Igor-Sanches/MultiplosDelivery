                            ...
                            <div class="d-flex flex-column h-100">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--100 rounded" id="viewer"
                                            src="{{my_asset('storage/app/public/delivery-man').'/'.$delivery_man['image']}}"
                                            onerror='this.src="{{my_asset('/assets/admin/img/admin.png')}}"'
                                ...
                                <div class="col-sm-6 col-lg-12">
                                    <div class="form-group mb-0">
                                        ...
                                        <select name="identity_type" class="form-control">
                                            <option {{$delivery_man['identity_type']=='rg'?'selected':''}} value="rg">{{ translate('messages.rg') }}</option>
                                            <option {{$delivery_man['identity_type']=='cnh'?'selected':''}} value="cnh">{{ translate('messages.driving_cnh') }}</option>
                                            <option
                                ...
                                <div class="col-md-6 pb-0">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-6 spartan_item_wrapper size--sm">
                                            <img class="rounded border" src="{{my_asset('storage/app/public/delivery-man').'/'.$img}}">
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
