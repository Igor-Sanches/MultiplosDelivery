...
@push('css_or_js')
    <link href="{{my_asset('assets/back-end')}}/css/select2.min.css" rel="stylesheet"/>
    <link href="{{my_asset('assets/back-end/css/croppie.css')}}" rel="stylesheet">
        ...
        <div class="container">
            ...
            <div class="mb-3">
                <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
                    <img width="20" src="{{my_asset('/assets/back-end/img/message.png')}}" alt="">
