            ...
            <div class="card-body">
                <div class="row align-items-md-center gx-md-5">
                    <div class="col-md-4 mb-3 mb-md-0">
                        <img class="rounded initial--5" src="{{my_asset('storage/app/public/campaign')}}/{{$campaign->image}}" onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="Image Description">
                    </div>
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($stores as $key=>$dm)
                        <tr>
                            <td>{{$key+1}}</td>
                            <td>
                                <img width="45" class="img--circle" onerror="this.src='{{my_asset('assets/admin/img/160x160/img1.jpg')}}'" src="{{my_asset('storage/app/public/store')}}/{{$dm['logo']}}">
                            </td>
                            <td>
