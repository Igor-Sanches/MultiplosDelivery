                            ...
                            <div class="form-group mb-0 h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="initial--4" id="viewer"
                                         src="{{my_asset('storage/app/public/campaign')}}/{{$campaign->image}}"
                                         onerror='this.src="{{ my_asset('assets/admin/img/900x400/img1.jpg') }}"' alt="campaign image"/>
                                </center>
    ...
    <script>
        ...
        <script>
            $('#reset_btn').click(function(){
                $('#viewer').attr('src','{{my_asset('storage/app/public/campaign')}}/{{$campaign->image}}');
            })
        </script>
@endpush
