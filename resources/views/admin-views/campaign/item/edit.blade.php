...
@push('css_or_js')
    <link href="{{my_asset('assets/admin/css/tags-input.min.css')}}" rel="stylesheet">
@endpush
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <center id="image-viewer-section" class="py-3 my-auto">
                                ...
                                src="{{my_asset('storage/app/public/campaign')}}/{{$campaign->image}}" alt="campaign image" onerror='this.src="{{my_asset('assets/admin/img/100x100/2.png')}}"'/>
                            </center>
                                ...
                                <div class="col-md-3 col-sm-6" id="addon_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1">{{translate('messages.addon')}}<span
                                                class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.store_required_warning')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_required_warning')}}"></span></label>
                                ...
                                <div class="col-md-3 col-sm-6">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1">{{translate('messages.sub_category')}}<span
                                                class="input-label-secondary" data-toggle="tooltip" data-placement="right" data-original-title="{{translate('messages.category_required_warning')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.category_required_warning')}}"></span></label>
...
@push('script_2')
    ...
    <script src="{{my_asset('assets/admin')}}/js/tags-input.min.js"></script>
