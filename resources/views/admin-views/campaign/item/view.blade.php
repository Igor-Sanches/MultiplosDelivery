            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <h1 class="page-header-title">
                    <span class="page-header-icon">
                        <img src="{{my_asset('assets/admin/img/product.png')}}" class="w--26" alt="">
                    </span>
                    <span>
                        {{$campaign['title']}}
                    </span>
            ...
            <div class="card-body">
                <div class="row align-items-md-center">
                    <div class="col-md-6 col-lg-4 mb-3 mb-md-0">
                            <img class="rounded img--ratio-3" src="{{my_asset('storage/app/public/campaign')}}/{{$campaign['image']}}" onerror="this.src='{{my_asset('/assets/admin/img/900x400/img1.jpg')}}'" alt="Image Description">
                    </div>
                    <div class="col-md-6">
                            ...
                            <div class="w-100 my-2">
                                <a href="{{route('admin.store.view', $campaign->store_id)}}" title="{{$campaign->store['name']}}">
                                    <img
                                        ...
                                        src="{{my_asset('storage/app/public/store/'.$campaign->store->logo)}}"
                            ...
                            <td>
                                @if($order->order->customer)
                                    <a class="text-body text-capitalize"
                                       href="{{route('admin.customer.view',['index', $order->order['user_id']])}}">{{$order->order->customer['f_name'].' '.$order->order->customer['l_name']}}</a>
                                @else
