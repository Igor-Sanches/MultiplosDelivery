<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-1" href="{{route('admin.dispatch.list',['searching_for_deliverymen'])}}">
       ...
       <img src="{{my_asset('/assets/admin/img/dashboard/1.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-2" href="{{route('admin.order.list',['accepted'])}}">
       ...
       <img src="{{my_asset('/assets/admin/img/dashboard/2.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-3" href="{{route('admin.order.list',['processing'])}}">
       ...
       <img src="{{my_asset('/assets/admin/img/dashboard/3.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
...
<div class="col-sm-6 col-lg-3">
    ...
    <a class="resturant-card dashboard--card card--bg-4" href="{{route('admin.order.list',['item_on_the_way'])}}">
       ...
       <img src="{{my_asset('/assets/admin/img/dashboard/4.png')}}" alt="img" class="resturant-icon">
    </a>
    <!-- End Card -->
</div>
    ...
    <div class="row g-2">
            ...
            <a class="order--card h-100" href="{{route('admin.order.list',['delivered'])}}">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{my_asset('/assets/admin/img/dashboard/statistics/1.png')}}" alt="dashboard" class="oder--card-icon">
        ...
        <div class="col-sm-6 col-lg-3">
            <a class="order--card h-100" href="{{route('admin.order.list',['canceled'])}}">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{my_asset('/assets/admin/img/dashboard/statistics/2.png')}}" alt="dashboard" class="oder--card-icon">
        ...
        <div class="col-sm-6 col-lg-3">
            <a class="order--card h-100" href="{{route('admin.order.list',['failed'])}}">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{my_asset('/assets/admin/img/dashboard/statistics/3.png')}}" alt="dashboard" class="oder--card-icon">
        ...
        <div class="col-sm-6 col-lg-3">
            <a class="order--card h-100" href="{{route('admin.order.list',['refunded'])}}">
                <div class="d-flex justify-content-between align-items-center">
                    <h6 class="card-subtitle d-flex justify-content-between m-0 align-items-center">
                        <img src="{{my_asset('/assets/admin/img/dashboard/statistics/4.png')}}" alt="dashboard" class="oder--card-icon">
