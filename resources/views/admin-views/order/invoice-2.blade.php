...
<main id="content" role="main" class="main pointer-event">
    <div class="content container-fluid">
        ...
        <div class="row">
            <div class="col-4">
                <img width="150"
                     src="{{my_asset('storage/app/public/restaurant')}}/{{\App\Models\BusinessSetting::where(['key'=>'logo'])->first()->value}}">
                <br><br>
                                ...
                                <div class="media">
                                    <div class="avatar avatar-xl mr-3">
                                        <img class="img-fluid"
                                             ...
                                             src="{{my_asset('storage/app/public/product')}}/{{$detail->product['image']}}"
