                            ...
                            <td>
                                @if($order->customer)
                                    <a class="text-body text-capitalize"
                                       href="{{route('admin.customer.view',['index', $order['user_id']])}}">{{$order->customer['f_name'].' '.$order->customer['l_name']}}</a>
                                @else
...
@push('script_2')
    <!-- <script src="{{my_asset('assets/admin')}}/js/bootstrap-select.min.js"></script> -->
    <script>
        <?php
            $filter_count=0;
