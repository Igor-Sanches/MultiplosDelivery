                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <h1 class="page-header-title">
                        <span class="page-header-icon">
                            <img src="{{ my_asset('/assets/admin/img/shopping-basket.png') }}" class="w--20"
                                alt="">
                        </span>
                        <span>
                    ...
                    <div class="card-header border-0 align-items-start flex-wrap">
                        ...
                        <div class="order-invoice-right mt-3 mt-sm-0">
                            ...
                            <div class="text-right mt-3 order-invoice-right-contents text-capitalize">
                                ...
                                @if($order['thing'] != null && $order['thing'] != 0.00)
                                    <h6 class="text-capitalize">
                                        {{ translate('messages.thing') }} :
                                        R$ {{ number_format($order['thing'] ?? 0, 2) }}
                                    </h6>
                                @endif
                                <h6 class="text-capitalize">
                                ...
                                @if ($order->order_attachment)
                                    ...
                                    <button class="btn w-100 px-0" data-toggle="modal" data-target="#imagemodal"
                                        ...
                                        <div class="gallary-card ml-auto">
                                            <img src="{{ my_asset('storage/app/' . 'public/order/' . $order->order_attachment) }}"
                    ...
                    <div class="card-body px-0">
                            ...
                            <div class="mx-3">
                                <div class="media align-items-center cart--media pb-2">
                                    <div class="avatar avatar-xl mr-3"
                                        ...
                                        <img class="img-fluid"
                                            src="{{ my_asset('storage/app/public/parcel_category') }}/{{ $order->parcel_category ? $order->parcel_category->image : '' }}"
                        ...
                        @else
                                                            ...
                                                            @if ($editing)
                                                                <div class="avatar avatar-xl mr-3 cursor-pointer"
                                                                    ...
                                                                    <img class="img-fluid rounded aspect-ratio-1"
                                                                        src="{{ my_asset('storage/app/public/product') }}/{{ $detail->item['image'] }}"
                                                                        onerror="this.src='{{ my_asset('assets/admin/img/160x160/img2.jpg') }}'"
                                                            ...
                                                            @if ($editing)
                                                                <div class="avatar avatar-xl mr-3  cursor-pointer"
                                                                    ...
                                                                    <img class="img-fluid rounded"
                                                                        src="{{ my_asset('storage/app/public/campaign') }}/{{ $detail->campaign['image'] }}"
                                                                        onerror="this.src='{{ my_asset('assets/admin/img/160x160/img2.jpg') }}'"
                                                                        alt="Image Description">
                                                                </div>
                                                            @else
                            ...
                            <?php
                                ...
                                $cashback_generated = $order['cashback_generated'];
                            ...
                            <div class="col-md-9 col-lg-8">
                                <dl class="row text-right">
                                    @if (!$parcel_order)
                                        ...
                                        <dt class="col-6 text-success">{{ translate('messages.cashback_generated') }}:</dt>
                                        <dd class="col-6 text-success">
                                            + {{ \App\CentralLogics\Helpers::format_currency($cashback_generated) }}
                                        </dd>
                                    @endif
                    ...
                    <div class="card-body pt-2">
                        ...
                        <div class="row g-3">
                            ...
                            @if ($data)
                                ...
                                <div class="col-3">
                                <img class="img__aspect-1 rounded border w-100" data-toggle="modal" data-target="#imagemodal{{ $key }}" onerror="this.src='{{ my_asset('assets/admin/img/160x160/img2.jpg') }}"
                                src="{{my_asset('storage/app/public/refund').'/'.$img}}">
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <img src="{{ my_asset('storage/app/' . 'public/refund/' . $img) }}"
                                                class="initial--22 w-100">
                                        </div>
                                        <div class="modal-footer">
                                            <a class="btn btn-primary"
                                ...
                                @else
                                <div class="col-3">
                                    <img class="img__aspect-1 rounded border w-100" onerror="this.src='{{ my_asset('assets/admin/img/160x160/img2.jpg') }}"
                                    src="{{ my_asset('assets/admin/img/160x160/img2.jpg') }}">
                                </div>
                            @endif
                        </div>
                        <hr>
                                ...
                                <a class="media align-items-center deco-none customer--information-single"
                                    ...
                                    <div class="avatar avatar-circle">
                                        <img class="avatar-img"
                                            onerror="this.src='{{ my_asset('assets/admin/img/160x160/img1.jpg') }}'"
                                            src="{{ my_asset('storage/app/public/delivery-man/' . $order->delivery_man->image) }}"
                                            alt="Image Description">
                                    </div>
                                    <div class="media-body">
                                        <span
                ...
                <div class="card mt-2">
                    <div class="card-body pt-3">
                        @if ($order->customer)
                            ...
                            <a class="media align-items-center deco-none customer--information-single"
                                href="{{ route('admin.customer.view', ['index', $order->customer['id']]) }}">
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img"
                                        onerror="this.src='{{ my_asset('assets/admin/img/160x160/img1.jpg') }}'"
                                        src="{{ my_asset('storage/app/public/profile/' . $order->customer->image) }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                            ...
                            <a class="media align-items-center deco-none resturant--information-single"
                                ...
                                <div class="avatar avatar-circle">
                                    <img class="avatar-img w-75px"
                                        onerror="this.src='{{ my_asset('assets/admin/img/100x100/1.png') }}'"
                                        src="{{ my_asset('storage/app/public/store/' . $order->store->logo) }}"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                                    <span class="fz--14px text--title font-semibold text-hover-primary d-block">
                                    ...
                                    <li class="list-group-item">
                                        <span class="dm_list" role='button' data-id="{{ $dm['id'] }}">
                                            <img class="avatar avatar-sm avatar-circle mr-1"
                                                onerror="this.src='{{ my_asset('assets/admin/img/160x160/img1.jpg') }}'"
                                                src="{{ my_asset('storage/app/public/delivery-man') }}/{{ $dm['image'] }}"
                                                alt="{{ $dm['name'] }}">
                                            {{ $dm['name'] }}
                                        </span>
        ...
        function initializeGMap() {
            ...
            @if ($order->store)
                var Restaurantmarker = new google.maps.Marker({
                    @if ($parcel_order)
                        ...
                        // icon: "{{ my_asset('assets/admin/img/restaurant_map.png') }}"
                    @else
                    ...
                    return function() {
                        @if ($parcel_order)
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{ my_asset('storage/app/public/profile/' . $order->customer->image) }}'></div><div style='float:right; padding: 10px;'><b>{{ $order->customer->f_name }}{{ $order->customer->l_name }}</b><br />{{ $address['address'] }}</div>"
                                );
                        @else
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{ my_asset('storage/app/public/restaurant/' . $order->store->logo) }}'></div><div class='text-break' style='float:right; padding: 10px;'><b>{{ Str::limit($order->store->name, 15, '...') }}</b><br /> {{ $order->store->address }}</div>"
                                );
                        @endif
            ...
            for (var i = 0; i < deliveryMan.length; i++) {
                if (deliveryMan[i].lat) {
                    // var contentString = "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{ my_asset('storage/app/public/delivery-man') }}/"+deliveryMan[i].image+"'></div><div style='float:right; padding: 10px;'><b>"+deliveryMan[i].name+"</b><br/> "+deliveryMan[i].location+"</div>";
                    ...
                    var marker = new google.maps.Marker({
                        ...
                        icon: "{{ my_asset('assets/admin/img/delivery_boy_map.png') }}"
                    });
                    dmMarkers[deliveryMan[i].id] = marker;
                    google.maps.event.addListener(marker, 'click', (function(marker, i) {
                        return function() {
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{ my_asset('storage/app/public/delivery-man') }}/" +
                                deliveryMan[i].image +
            ...
            function initializegLocationMap() {
                ...
                @if ($order->customer && isset($address))
                    var marker = new google.maps.Marker({
                        ...
                        icon: "{{ my_asset('assets/admin/img/customer_location.png') }}"
                    });
                ...
                @if ($order->delivery_man && $order->dm_last_location)
                    ...
                    google.maps.event.addListener(dmmarker, 'click', (function(dmmarker) {
                        return function() {
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{ my_asset('storage/app/public/delivery-man/' . $order->delivery_man->image) }}'></div> <div style='float:right; padding: 10px;'><b>{{ $order->delivery_man->f_name }} {{ $order->delivery_man->l_name }}</b><br /> {{ $order->dm_last_location['location'] }}</div>"
                                );
                ...
                @if ($order->store)
                    ...
                    google.maps.event.addListener(Retaurantmarker, 'click', (function(Retaurantmarker) {
                        return function() {
                            infowindow.setContent(
                                "<div style='float:left'><img style='max-height:40px;wide:auto;' src='{{ my_asset('storage/app/public/restaurant/' . $order->store->logo) }}'></div> <div style='float:right; padding: 10px;'><b>{{ Str::limit($order->store->name, 15, '...') }}</b><br /> {{ $order->store->address }}</div>"
                                );
