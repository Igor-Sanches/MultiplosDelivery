                ...
                <div class="col-md-5">
                    <div class="zone-setup-instructions">
                        ...
                        <div class="instructions-image mt-4">
                            <img src="{{my_asset('assets/admin/img/instructions.gif')}}" alt="instructions">
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-7 zone-setup">
                    <div class="pl-xl-5 pl-xxl-0">
                        ...
                        <div class="check--item-wrapper mb-1">
                            ...
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="payment_credit_card_offline" value="payment_credit_card_offline" class="form-check-input"
                                           {{$zone->payment_credit_card_offline ? 'checked' : ''}}
                                           id="payment_credit_card_offline">
                                    <label class="form-check-label qcont text-dark" for="payment_credit_card_offline">{{translate('messages.payment_credit_card_offline')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="payment_debit_card_offline" value="payment_debit_card_offline" class="form-check-input"
                                           {{$zone->payment_debit_card_offline ? 'checked' : ''}}
                                           id="payment_debit_card_offline">
                                    <label class="form-check-label qcont text-dark" for="payment_debit_card_offline">{{translate('messages.payment_debit_card_offline')}}</label>
                                </div>
                            </div>
                            <div class="check-item">
                                <div class="form-group form-check form--check">
                                    <input type="checkbox" name="payment_pix_offline" value="payment_pix_offline" class="form-check-input"
                                           {{$zone->payment_pix_offline ? 'checked' : ''}}
                                           id="payment_pix_offline">
                                    <label class="form-check-label qcont text-dark" for="payment_pix_offline">{{translate('messages.payment_pix_offline')}}</label>
                                </div>
                            </div>
                        </div>
