                                    ...
                                    <td>
                                        <div class="btn--container justify-content-center">
                                            <a class="btn btn--primary btn-outline-primary"
                                               href="{{route('admin.zone.edit-delivery-fee',[$zone['id']])}}" title="{{translate('messages.config_delivery_fee')}}"><span>@lang('messages.config_delivery_fee')</span> <i class="tio-money"></i>
                                            </a>
