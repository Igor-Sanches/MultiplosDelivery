        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/category.png')}}" class="w--20" alt="">
                </span>
                <span>
                            ...
                            <div class="h-100 d-flex flex-column">
                                ...
                                <center class="py-3 my-auto">
                                    <img class="img--100" id="viewer"
                                        @if(isset($category))
                                        src="{{my_asset('storage/app/public/category')}}/{{$category['image']}}"
                                        @else
                                        src="{{my_asset('assets/admin/img/900x400/img1.jpg')}}"
                                        @endif
                                        alt="image"/>
                                </center>
                ...
                <div class="search--button-wrapper">
                    ...
                    <form id="dataSearch" class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input type="search" name="search" class="form-control min-height-45" placeholder="{{translate('messages.search_categories')}}" aria-label="{{translate('messages.ex_categories')}}">
