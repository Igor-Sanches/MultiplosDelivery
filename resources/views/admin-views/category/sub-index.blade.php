                ...
                <div class="search--button-wrapper">
                    ...
                    <form id="dataSearch" class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch" name="search" type="search" class="form-control" placeholder="{{translate('messages.ex_search_sub_categories')}}" aria-label="{{translate('messages.ex_sub_categories')}}">
