            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        <a href="{{my_asset('assets/categories_bulk_format.xlsx')}}" download="" class="btn btn-dark">{{ translate('Template with Existing Data') }}</a>
                        <a href="{{my_asset('assets/categories_bulk_without_data_format.xlsx')}}" download="" class="btn btn-dark">{{ translate('Template without Data') }}</a>
                    </div>
                </div>
            </div>
