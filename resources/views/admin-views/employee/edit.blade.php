                    ...
                    <div class="col-md-4">
                        <label class="h-100 d-flex flex-column">
                            <center class="py-3 my-auto">
                                ...
                                onerror="this.src='{{my_asset('assets/front-end/img/image-place-holder.png')}}'"
                                src="{{my_asset('storage/app/public/admin')}}/{{$e['image']}}" alt="Employee thumbnail"/>
                            </center>
...
<script>
    ...
    <script>
        $('#reset_btn').click(function(){
            $('#viewer').attr('src', "{{my_asset('storage/app/public/admin')}}/{{$e['image']}}') }}");
