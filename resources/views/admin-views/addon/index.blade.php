        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/addon.png')}}" class="w--20" alt="">
                </span>
                <span>
                    ...
                    <div>
                        <form id="search-form" class="search-form">
                            ...
                            <div class="input-group input--group">
                                <input id="datatableSearch" type="search" name="search" class="form-control min-height-45" placeholder="{{translate('messages.ex_addons_name')}}" aria-label="Search addons">
        ...
        $(document).on('ready', function () {
          ...
          language: {
            zeroRecords: '<div class="text-center p-4">' +
                '<img class="mb-3 w-7rem" src="{{my_asset('assets/admin/svg/illustrations/sorry.svg')}}" alt="Image Description">' +
