            ...
            <div class="card-body">
                ...
                <div class="text-center pb-4">
                    ...
                    <div class="btn--container justify-content-center export--template-btns">
                        <a href="{{my_asset('assets/addons_bulk_format.xlsx')}}" download="" class="btn btn-dark">{{ translate('messages.Template with Existing Data') }}</a>
                        <a href="{{my_asset('assets/addons_bulk_format_nodata.xlsx')}}" download="" class="btn btn-dark">{{ translate('messages.Template without Data') }}</a>
                    </div>
                </div>
            </div>
        </div>
