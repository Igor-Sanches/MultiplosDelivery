        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/items.png')}}" class="w--22" alt="">
                </span>
                <span>
                        ...
                        <div class="card-body d-flex flex-column">
                            ...
                            <center id="image-viewer-section" class="pt-2 pb-3 initial-hidden">
                                <img class="img--100" id="viewer"
                                        src="{{my_asset('assets/admin/img/400x400/img2.jpg')}}" alt="banner image"/>
                            </center>
                                ...
                                <div class="col-sm-6 col-lg-4" id="addon_input">
                                    <div class="form-group mb-0">
                                        <label class="input-label" for="exampleFormControlSelect1">{{translate('messages.addon')}}<span
                                                class="input-label-secondary" title="{{translate('messages.addon')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.store_required_warning')}}"></span></label>
