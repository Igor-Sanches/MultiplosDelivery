                ...
                <div class="card h-100">
                    <div class="card-body d-flex flex-column justify-content-center">
                        ...
                        <a class="resturant--information-single" href="{{route('admin.store.view', $product->store_id)}}">
                            <img class="img--120 rounded mx-auto mb-3" onerror="this.src='{{my_asset('assets/admin/img/160x160/img1.jpg')}}'" src="{{my_asset('storage/app/public/store/'.$product->store->logo)}}" alt="Image Description">
