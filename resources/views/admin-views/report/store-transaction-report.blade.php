    ...
    <div class="store-report-content mt-11px">
        <div class="left-content">
            <div class="left-content-card">
                <img src="{{my_asset('/assets/admin/img/report/trx-1.svg')}}" alt="">
                <div class="info">
            ...
            <div class="left-content-card">
                <img src="{{my_asset('/assets/admin/img/report/trx-2.svg')}}" alt="">
                <div class="info">
            ...
            <div class="left-content-card">
                <img src="{{my_asset('/assets/admin/img/report/trx-3.svg')}}" alt="">
                <div class="info">
                    <h4 class="subtitle __txt-22">$3,330</h4>
