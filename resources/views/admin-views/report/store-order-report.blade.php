    ...
    <div class="content container-fluid">
        ...
        <div class="store-report-content mt-11px">
            <div class="left-content">
                ...
                <div class="left-content-card">
                    <img src="{{ my_asset('/assets/admin/img/report/total-order.svg') }}" alt="">
                    <div class="info">
                ...
                <div class="left-content-card">
                    <img src="{{ my_asset('/assets/admin/img/report/total-discount.svg') }}" alt="">
                    <div class="info">
                        <h4 class="subtitle">
                                    ...
                                    <td>
                                        @if ($order->customer)
                                            <a class="text-body text-capitalize"
                                                href="{{ route('admin.customer.view', ['index', $order['user_id']]) }}">
...
@push('script')
    ...
    <script
        src="{{ my_asset('assets/admin') }}/vendor/chartjs-plugin-datalabels/dist/chartjs-plugin-datalabels.min.js">
    </script>
