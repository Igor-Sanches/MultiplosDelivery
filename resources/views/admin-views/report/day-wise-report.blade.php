        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{ my_asset('assets/admin/img/report.png') }}" class="w--22" alt="">
                </span>
                <span>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-1">
                            ...
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/earned.png') }}"
                                alt="order-report">
                        </div>
                        <!-- End Card -->
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-2">
                            ...
                            <span class="subtitle">{{ translate('messages.store') }}
                                {{ translate('messages.earned') }}</span>
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/res-earned.png') }}"
                                alt="order-report">
                        </div>
                        <!-- End Card -->
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-3">
                            ...
                            <img class="resturant-icon"
                                src="{{ my_asset('assets/admin/img/report/delivery-fee.png') }}" alt="order-report">
                        </div>
                        <!-- End Card -->
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-4">
                            ...
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/sell.png') }}"
                                alt="order-report">
                        </div>
                        <!-- End Card -->
                    </div>
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-4">
                            <h4 class="title">R$ {{number_format($totalSum, 2)}}</h4>
                            <span class="subtitle">@lang('messages.add_it_all_up')</span>
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/sell.png') }}"
                                 alt="order-report">
                        </div>
                        <!-- End Card -->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-2">
                            <h4 class="title">R$ {{number_format(\App\CentralLogics\Helpers::user_report($transactions, 'cashback')??0, 2)}}</h4>
                            <span class="subtitle">@lang('messages.cashback')</span>
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/sell.png') }}"
                                 alt="order-report">
                        </div>
                        <!-- End Card -->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-3">
                            <h4 class="title">R$ {{number_format(\App\CentralLogics\Helpers::user_report($transactions, 'reference')??0, 2)}}</h4>
                            <span class="subtitle">@lang('messages.reference')</span>
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/sell.png') }}"
                                 alt="order-report">
                        </div>
                        <!-- End Card -->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        <!-- Card -->
                        <div class="resturant-card resturant-card-2 card--bg-1">
                            <h4 class="title">R$ {{number_format(\App\CentralLogics\Helpers::user_report($transactions, 'affiliate')??0, 2)}}</h4>
                            <span class="subtitle">@lang('messages.affiliate')</span>
                            <img class="resturant-icon" src="{{ my_asset('assets/admin/img/report/sell.png') }}"
                                 alt="order-report">
                        </div>
                        <!-- End Card -->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-4">
                            ...
                            <img src="{{ my_asset('assets/admin/img/report/progress.png') }}" alt="dashboard"
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-3">
                            ...
                            <img src="{{ my_asset('assets/admin/img/report/delivered.png') }}" alt="dashboard"
                                class="resturant-icon">
                        </div>
                    </div>
                    <!--Delivered End-->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-2">
                            ...
                            <img src="{{ my_asset('assets/admin/img/report/failed.png') }}" alt="dashboard"
                                class="resturant-icon">
                        </div>
                    </div>
                    <!--Failed End-->
                    ...
                    <div class="col-sm-6 col-xl-3">
                        ...
                        <div class="resturant-card resturant-card-2 card--bg-1">
                            ...
                            <img src="{{ my_asset('assets/admin/img/report/canceled.png') }}" alt="dashboard"
                                class="resturant-icon">
                        </div>
                    </div>
                    <!--canceled End-->
                    ...
                    <table id="datatable" class="table table-thead-bordered table-align-middle card-table">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th class="border-0">{{ translate('messages.cashback') }}</th>
                                <th class="border-0">{{ translate('messages.reference') }}</th>
                                <th class="border-0">{{ translate('messages.affiliate') }}</th>
                                <th class="border-0">{{ trans('messages.total_order_amount') }}</th>
                        ...
                        <tbody id="set-rows">
                            @foreach ($order_transactions as $k => $ot)
                                <tr scope="row">
                                    ...
                                    <td>{{\App\CentralLogics\Helpers::format_currency($ot->cashback_generated)}}</td>
                                    <td>{{\App\CentralLogics\Helpers::format_currency(get_value_in_array($ot->toArray()['translation_order'], 'reference'))}}</td>
                                    <td>{{\App\CentralLogics\Helpers::format_currency(get_value_in_array($ot->toArray()['translation_order'], 'affiliate'))}}</td>
...
@push('script_2')
    ...
    <script src="{{ my_asset('assets/admin') }}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
    <script src="{{ my_asset('assets/admin') }}/js/hs.chartjs-matrix.js"></script>
