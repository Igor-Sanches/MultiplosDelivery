                    ...
                    <tr>
                        ...
                        <td>
                            <a class="media align-items-center" href="{{route('admin.item.view',[$item['id']])}}">
                                <img class="avatar avatar-lg mr-3" src="{{my_asset('storage/app/public/product')}}/{{$item['image']}}" onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{$item->name}} image">
