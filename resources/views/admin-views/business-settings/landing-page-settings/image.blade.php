    ...
    <div class="page-header pb-0">
        <h1 class="page-header-title">
            <span class="page-header-icon">
                <img src="{{my_asset('assets/admin/img/landing.png')}}" class="w--26" alt="">
            </span>
            <span>
                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section" class="pt-4">
                                <img class="img--200 border" id="viewer" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['top_content_image'])?$landing_page_images['top_content_image']:'double_screen_image.png'}}"
                                        onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'"
                                        alt=""/>
                            </center>
                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section2" class="pt-4">
                                <img  class="img--200 border" id="viewer2" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['about_us_image'])?$landing_page_images['about_us_image']:'about_us_image.png'}}" onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'" alt=""/>
                            </center>
                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section3" class="pt-4">
                                <img  class="img--200 border" id="viewer3" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['feature_section_image'])?$landing_page_images['feature_section_image']:'feature_section_image.png'}}" onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'"
                                        alt=""/>
                            </center>
                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <center id="image-viewer-section4" class="pt-2">
                                <img class="img--200" id="viewer4" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['mobile_app_section_image'])?$landing_page_images['mobile_app_section_image']:'our_app_image.png.png'}}" onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'" alt=""/>
                            </center>
                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'image')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <center id="image-viewer-section8" class="pt-2">
                                <img class="img--200" id="viewer8" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['contact_us_image'])?$landing_page_images['contact_us_image']:'our_app_image.png.png'}}" onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'" alt=""/>
                            </center>
