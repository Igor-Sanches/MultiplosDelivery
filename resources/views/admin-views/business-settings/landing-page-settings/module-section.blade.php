                                    ...
                                    <div class="col-sm-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <center id="image-viewer-section-{{$key}}" class="pt-4">
                                                <img class="img--120" id="viewer-{{$key}}" src="{{my_asset('assets/landing')}}/image/{{isset($module_value['img']) ? $module_value['img']:'double_screen_image.png'}}"
                                                onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'" alt=""/>
                                            </center>
                                        </div>
                                    </div>
                                </div>
...
@push('script_2')
    <script>
        ...
        $('#reset_btn').click(function(){
            $('#viewer-{{$key}}').attr('src','{{my_asset('assets/admin/img/400x400/img2.jpg')}}');
        })
        @endforeach
