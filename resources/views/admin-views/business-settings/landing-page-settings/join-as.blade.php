                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'joinas')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section5" class="pt-3 img--200 mx-auto">
                                <img class="border rounded w-100" id="viewer5" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['seller_banner_bg'])?$landing_page_images['seller_banner_bg']:'double_screen_image.png'}}"
                    ...
                    <form action="{{route('admin.business-settings.landing-page-settings', 'joinas')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section6" class="pt-3 img--200 mx-auto">
                                <img class="border rounded w-100" id="viewer6" src="{{my_asset('assets/landing')}}/image/{{isset($landing_page_images['deliveryman_banner_bg'])?$landing_page_images['deliveryman_banner_bg']:'double_screen_image.png'}}"
                                        onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'"
                                        alt=""/>
                            </center>
