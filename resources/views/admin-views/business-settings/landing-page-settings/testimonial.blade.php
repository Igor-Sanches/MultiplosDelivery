                ...
                <div class="form-group">
                    ...
                    <center id="image-viewer-section" class="initial-hidden pt-2">
                        <img class="img--120" id="viewer"
                                src="{{my_asset('assets/admin/img/400x400/img2.jpg')}}" alt=""/>
                    </center>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="media align-items-center">
                                        <img class="avatar avatar-lg mr-3" src="{{my_asset('assets/landing/image')}}/{{isset($sp['img']) ? $sp['img'] : ''}}"
                                                onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{$sp['name']}}">
                                ...
                                <td>{{$sp['position']}}</td>
                                <td>
                                    <img class="avatar avatar-lg mr-3" src="{{my_asset('assets/landing/image')}}/{{isset($sp['brand_image']) ? $sp['brand_image'] : ''}}"
                                    onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{$sp['name']}}">
                            <div class="media-body">
                                </td>
                                <td class="inline--3">
