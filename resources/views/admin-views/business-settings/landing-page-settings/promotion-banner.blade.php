                    ...
                    <tbody>
                        ...
                        @foreach ($promotion_banner as $key=>$promotion)
                            <tr>
                                ...
                                <td>
                                    <img class="avatar avatar-lg mr-3 w-100" src="{{my_asset('assets/landing/image')}}/{{$promotion['img']}}"
                                    onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{$promotion['title']}}">
