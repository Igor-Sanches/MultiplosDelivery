                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section" class="pt-4">
                                <img class="img--200 border" id="viewer"
                                        src="{{my_asset('assets/landing')}}/image/{{isset($web_app_landing_page_settings['top_content_image'])?$web_app_landing_page_settings['top_content_image']:'double_screen_image.png'}}"
                        ...
                        <label class="form-group d-block">
                            ...
                            <center id="image-viewer-section4" class="pt-4">
                                <img class="img--200 border" id="viewer4"
                                        src="{{my_asset('assets/landing')}}/image/{{isset($web_app_landing_page_settings['mobile_app_section_image'])?$web_app_landing_page_settings['mobile_app_section_image']:'our_app_image.png.png'}}"
                                        onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'"
                                        alt=""/>
                            </center>
