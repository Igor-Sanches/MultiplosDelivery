...
@section('content')
    <div class="content container-fluid">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <h1 class="page-header-title">
                    <span class="page-header-icon">
                        <img src="{{my_asset('/assets/admin/img/payment.png')}}" class="w--22" alt="">
                    </span>
                    <span>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body pt-3">
                        @php($payment_pix_offline=\App\CentralLogics\Helpers::get_business_settings('payment_pix_offline'))
                        <form action="{{route('admin.business-settings.payment-method-update',['payment_pix_offline'])}}"
                              method="post">
                            @csrf
                            <h5 class="text-capitalize mb-3">{{translate('messages.payment_pix_offline')}}</h5>
                            <div class="d-flex flex-wrap p-0">
                                <label class="form-check form--check mr-2 mr-md-4">
                                    <input class="form-check-input payment_pix_offline" type="radio" name="status" value="1" {{$payment_pix_offline?($payment_pix_offline['status']==1?'checked':''):''}}>
                                    <span class="form-check-label">{{translate('messages.active')}}</span>
                                </label>
                                <label class="form-check form--check">
                                    <input class="form-check-input payment_pix_offline" type="radio" name="status" value="0" {{$payment_pix_offline?($payment_pix_offline['status']==0?'checked':''):''}}>
                                    <span class="form-check-label">{{translate('messages.inactive')}}</span>
                                </label>
                            </div>
                            <div class="text-right mt-4 pt-2 mr-2">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body pt-3">
                        @php($payment_credit_card_offline=\App\CentralLogics\Helpers::get_business_settings('payment_credit_card_offline'))
                        <form action="{{route('admin.business-settings.payment-method-update',['payment_credit_card_offline'])}}"
                              method="post">
                            @csrf
                            <h5 class="text-capitalize mb-3">{{translate('messages.payment_credit_card_offline')}}</h5>
                            <div class="d-flex flex-wrap p-0">
                                <label class="form-check form--check mr-2 mr-md-4">
                                    <input class="form-check-input payment_credit_card_offline" type="radio" name="status" value="1" {{$payment_credit_card_offline?($payment_credit_card_offline['status']==1?'checked':''):''}}>
                                    <span class="form-check-label">{{translate('messages.active')}}</span>
                                </label>
                                <label class="form-check form--check">
                                    <input class="form-check-input payment_credit_card_offline" type="radio" name="status" value="0" {{$payment_credit_card_offline?($payment_credit_card_offline['status']==0?'checked':''):''}}>
                                    <span class="form-check-label">{{translate('messages.inactive')}}</span>
                                </label>
                            </div>
                            <div class="text-right mt-4 pt-2 mr-2">
            ...
            <div class="col-md-6">
                <div class="card h-100">
                    ...
                    <div class="card-body pt-3">
                        @php($payment_debit_card_offline=\App\CentralLogics\Helpers::get_business_settings('payment_debit_card_offline'))
                        <form action="{{route('admin.business-settings.payment-method-update',['payment_debit_card_offline'])}}"
                              method="post">
                            @csrf
                            <h5 class="text-capitalize mb-3">{{translate('messages.payment_debit_card_offline')}}</h5>
                            <div class="d-flex flex-wrap p-0">
                                <label class="form-check form--check mr-2 mr-md-4">
                                    <input class="form-check-input payment_debit_card_offline" type="radio" name="status" value="1" {{$payment_debit_card_offline?($payment_debit_card_offline['status']==1?'checked':''):''}}>
                                    <span class="form-check-label">{{translate('messages.active')}}</span>
                                </label>
                                <label class="form-check form--check">
                                    <input class="form-check-input payment_debit_card_offline" type="radio" name="status" value="0" {{$payment_debit_card_offline?($payment_debit_card_offline['status']==0?'checked':''):''}}>
                                    <span class="form-check-label">{{translate('messages.inactive')}}</span>
                                </label>
                            </div>
                            <div class="text-right mt-4 pt-2 mr-2">
        ...
        <div hidden class="row digital_payment_methods mt-3 g-3">
                ...
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/sslcommerz.png')}}" alt="public">
                        </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/paypal.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/razorpay.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/stripe.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/paystack.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/senang-pay.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/flutterwave.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/mercador-pago.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Public Key" name="public_key"
                                           value="{{env('APP_MODE')!='demo'?$config['public_key']:''}}">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/paymob.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/bkash.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Api Key" name="api_key"
                                           value="{{env('APP_MODE')!='demo'?$config['api_key']:''}}">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/paytabs.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/paytm.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body p-30px">
                        ...
                        <div class="payment--gateway-img">
                            <img src="{{my_asset('/assets/admin/img/payment/liqpay.png')}}" alt="public">
                        </div>
                            <div class="form-group mb-4">
                                <input class="form-control" type="text" placeholder="Public Key" name="public_key"
                                           value="{{env('APP_MODE')!='demo'?$config['public_key']:''}}">
