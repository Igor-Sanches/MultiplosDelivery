                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            ...
                            <select name="module_type" id="module_type" class="form-control text-capitalize" onchange="modulChange(this.value)">
                                ...
                                <option class="" value="{{$key}}">{{trans('messages.'.$key)}}</option>
                                @endforeach
                            </select>
                                    ...
                                    <div class="row h-100">
                                        <div class="col-sm-6 mb-4 mb-sm-0">
                                            <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                                ...
                                                <center class="my-auto py-3">
                                                    <img class="initial--15" id="viewer" src="{{my_asset('assets/admin/img/400x400/img2.jpg')}}" alt="image" />
                                                </center>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                                ...
                                                <center class="my-auto py-3">
                                                    <img class="initial--15" id="viewer2" src="{{my_asset('assets/admin/img/400x400/img2.jpg')}}" alt="image" />
                                                </center>
                                                <div class="custom-file">
...
<script>
        $('#reset_btn').click(function(){
            ...
            $('#viewer2').attr('src','{{my_asset('assets/admin/img/400x400/img2.jpg')}}');
        })
</script>
@endpush
