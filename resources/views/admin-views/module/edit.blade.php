...
@push('css_or_js')
<link rel="stylesheet" href="{{my_asset('assets/admin/css/radio-image.css')}}">
@endpush
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/module.png')}}" alt="">
                </span>
                <span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group" id="zone_check">
                                <label class="input-label">{{ translate('Store can serve in') }} <small class="text-danger"><span class="input-label-secondary"
                                        ...
                                        <img src="{{ my_asset('/assets/admin/img/info-circle.svg') }}"
                    ...
                    <div class="form-group" id="module_theme" >
                        ...
                        <div class="row">
                            <div class='col-lg-3 col-sm-6 col-12 text-center'>
                                ...
                                <label for="img1">
                                    <img class="img-thumbnail rounded" src="{{my_asset('assets/admin/img/Theme-1.png')}}" alt="Image 1">
                                </label>
                            </div>
                            <div class='col-lg-3 col-sm-6 col-12 text-center'>
                                <input type="radio" name="theme" require id="img2" class="d-none imgbgchk" value="2" {{$module->theme_id==2?'checked':''}}>
                                <label for="img2">
                                    <img class="img-thumbnail rounded" src="{{my_asset('assets/admin/img/Theme-2.png')}}" alt="Image 2">
                                </label>
                            </div>
                            <div class="col-lg-6">
                                        ...
                                        <div class="row h-100">
                                            <div class="col-sm-6">
                                                <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                                    ...
                                                    <center class="my-auto py-3">
                                                        <img class="initial--15 " id="viewer" onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'" src="{{my_asset('storage/app/public/module/'.$module['icon'])}}" alt="image" />
                                                    </center>
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group m-0 h-100 d-flex flex-column justify-content-center">
                                                    ...
                                                    <center class="my-auto py-3">
                                                        <img class="initial--15 " id="viewer2" onerror="this.src='{{my_asset('assets/admin/img/400x400/img2.jpg')}}'" src="{{my_asset('storage/app/public/module/'.$module['thumbnail'])}}" alt="image" />
                                                    </center>
                                                    <div class="custom-file">
...
@push('script_2')
    ...
    <script>
        $('#reset_btn').click(function(){
            $('#viewer').attr('src','{{my_asset('storage/app/public/module/'.$module['icon'])}}');
            $('#viewer2').attr('src','{{my_asset('storage/app/public/module/'.$module['thumbnail'])}}');
        })
</script>
@endpush
