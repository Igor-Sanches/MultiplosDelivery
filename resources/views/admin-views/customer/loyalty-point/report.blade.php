        ...
        <div class="page-header">
            <h1 class="page-header-title mr-3">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/customer-loyalty.png')}}" class="w--26" alt="">
                </span>
                <span>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        <div class="resturant-card dashboard--card card--bg-1">
                            ...
                            <img class="resturant-icon" src="{{my_asset('assets/admin/img/customer-loyality/1.png')}}" alt="dashboard">
                        </div>
                    </div>
                    <!--Debit earned End-->
                    <!--credit earned-->
                    <div class="col-md-4">
                        <div class="resturant-card dashboard--card card--bg-2">
                            ...
                            <img class="resturant-icon" src="{{my_asset('assets/admin/img/customer-loyality/2.png')}}" alt="dashboard">
                        </div>
                    </div>
                    <!--credit earned end-->
                    <!--balance earned-->
                    <div class="col-md-4">
                        <div class="resturant-card dashboard--card card--bg-3">
                            ...
                            <img class="resturant-icon" src="{{my_asset('assets/admin/img/customer-loyality/3.png')}}" alt="dashboard">
                        </div>
                    </div>
                    <!--balance earned end-->
                </div>
                    ...
                    <table id="datatable"
                        ...
                        @foreach($transactions as $k=>$wt)
                            <tr scope="row">
                                ...
                                <td><a href="{{route('admin.customer.view',['index', 'user_id'=>$wt->user_id])}}">{{Str::limit($wt->user?$wt->user->f_name.' '.$wt->user->l_name:__('messages.not_found'),20,'...')}}</a></td>
                                <td>{{$wt->credit}}</td>
                                <td>{{$wt->debit}}</td>
                                <td>{{$wt->balance}}</td>
                                <td>
...
@push('script_2')
    ...
    <script
        src="{{my_asset('assets/admin')}}/vendor/chartjs-chart-matrix/dist/chartjs-chart-matrix.min.js"></script>
