        ...
        <div class="card">
            <div class="card-header border-0 py-2">
                <div class="search--button-wrapper">
                    <h5 class="card-title"> {{translate('extracted_list')}} <span class="badge badge-soft-secondary">{{ $affiliates_extracted->total() }}</span></h5>
            ...
            <div class="table-responsive datatable-custom">
                <table id="columnSearchDatatable"
                    ...
                    <tbody>
                    @foreach($affiliates_extracted as $key=>$affiliate)
                        <tr>
                            <td>
                ...
                @if(count($affiliates_extracted) !== 0)
                    <hr>
                @endif
                <div class="page-area">
                    {!! $affiliates_extracted->links() !!}
                </div>
                @if(count($affiliates_extracted) === 0)
