        ...
        <div class="card">
            <div class="card-header border-0 py-2">
                <div class="search--button-wrapper">
                    <h5 class="card-title"> {{translate('cashback_list')}} <span class="badge badge-soft-secondary">{{ $cashbacks->total() }}</span></h5>
                ...
                <table id="columnSearchDatatable"
                    ...
                    @foreach($cashbacks as $key=>$cashback)
                        <tr>
                            ...
                            <td>
                                R$ {{number_format($cashback->credit, 2)}}
                            </td>
                            <td>
                                R$ {{number_format($cashback->balance, 2)}}
                            </td>
                            <td>
                                {{now()->setTimeFromTimeString($cashback->created_at)->format('d/m/Y H:m')}}
                            </td>
