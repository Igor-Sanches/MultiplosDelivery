...
@section('content')
    <div class="content container-fluid config-inline-remove-class">
        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/config.png')}}" class="w--30" alt="">
                </span>
                <span>
            ...
            <div class="card-body py-3">
                <div class="d-flex flex-row justify-content-between align-items-center">
                    <h4 class="card-title align-items-center d-flex">
                        <img src="{{my_asset('assets/admin/img/store.png')}}" class="w--20 mr-1" alt="">
                        ...
                        <div class="form-group m-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border rounded px-3 form-control" for="free_delivery">
                                <span class="pr-2">
                                    ...
                                    <span data-toggle="tooltip" data-placement="right" data-original-title="{{translate('If this option is on, customers will get free delivery')}}" class="input-label-secondary"><img src="{{my_asset('assets/admin/img/info-circle.svg')}}" alt="i"></span>
                                </span>
            ...
            <div class="card-body">
                <form action="{{route('vendor.business-settings.update-setup',[$store['id']])}}" method="post"
                    ...
                    <div class="row">
                        ...
                        <div class="form-group mb-0 col-md-4">
                            <label class="input-label text-capitalize" for="maximum_delivery_time">{{translate('messages.minimum_processing_time')}}<span class="input-label-secondary" title="{{translate('messages.minimum_processing_time_warning')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.minimum_processing_time_warning')}}"></span></label>
                        ...
                        {{-- <div class="col-sm-{{$store->self_delivery_system?'4':'6'}}">
                            <div class="form-group mb-0 p-2 border">
                                <label class="d-flex justify-content-between switch toggle-switch-sm text-dark" for="gst_status">
                                    <span>{{translate('messages.gst')}} <span class="input-label-secondary" title="{{translate('messages.gst_status_warning')}}"><img src="{{my_asset('/assets/admin/img/info-circle.svg')}}" alt="{{translate('messages.gst_status_warning')}}"></span></span>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_offline">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('vendor.business-settings.toggle-settings',[$store->id,$store->payment_offline?0:1, 'payment_offline'])}}'" id="payment_offline" {{$store->payment_offline?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_pix_offline">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('vendor.business-settings.toggle-settings',[$store->id,$store->payment_pix_offline?0:1, 'payment_pix_offline'])}}'" id="payment_pix_offline" {{$store->payment_pix_offline?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_credit_card_offline">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('vendor.business-settings.toggle-settings',[$store->id,$store->payment_credit_card_offline?0:1, 'payment_credit_card_offline'])}}'" id="payment_credit_card_offline" {{$store->payment_credit_card_offline?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
                    ...
                    <div class="col-sm-6 col-lg-4">
                        <div class="form-group mb-0">
                            <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="payment_debit_card_offline">
                                ...
                                <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('vendor.business-settings.toggle-settings',[$store->id,$store->payment_debit_card_offline?0:1, 'payment_debit_card_offline'])}}'" id="payment_debit_card_offline" {{$store->payment_debit_card_offline?'checked':''}}>
                                <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                            </label>
        ...
        @if($store->delivery && $store->self_delivery_system)
            <div class="card mt-3">
            <div class="card-header">
                <h5 class="card-title">
            ...
            <div class="card-body">
                <form action="{{route('vendor.business-settings.update-setup-delivery-radius',[$store['id']])}}" method="post"
                      enctype="multipart/form-data">
                    @csrf
                    <div class="row g-3">
                        <div class="col-sm-6 col-lg-4">
                            <div class="form-group mb-0">
                                ...
                                <label class="toggle-switch toggle-switch-sm d-flex justify-content-between border border-secondary rounded px-4 form-control" for="is_delivery_radius">
                                    ...
                                    <input type="checkbox" class="toggle-switch-input" onclick="location.href='{{route('vendor.business-settings.toggle-settings',[$store->id,$store->is_delivery_radius?0:1, 'is_delivery_radius'])}}'" id="is_delivery_radius" {{$store->is_delivery_radius?'checked':''}}>
                                    <span class="toggle-switch-label">
                                    <span class="toggle-switch-indicator"></span>
                                </span>
                                </label>
