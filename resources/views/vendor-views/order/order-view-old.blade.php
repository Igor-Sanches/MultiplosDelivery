                                ...
                                @if ($order->order_attachment)
                                    ...
                                    <button class="btn w-100"  data-toggle="modal" data-target="#imagemodal" title="{{translate('messages.order')}} {{translate('messages.attachment')}}">
                                        <div class="gallary-card">
                                            <img src="{{my_asset('storage/app/'.'public/order/'.$order->order_attachment)}}" alt="{{translate('messages.prescription')}}" style="height:auto;width:50%;">
                                        </div>
                                    </button>
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <img src="{{my_asset('storage/app/'.'public/order/'.$order->order_attachment)}}" style="width: 100%; height: auto;" >
                                                </div>
