        ...
        <div class="page-header">
            <h1 class="page-header-title text-capitalize">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/order.png')}}" class="w--26" alt="">
                </span>
                <span>
                ...
                <div class="search--button-wrapper justify-content-end">
                        <form action="javascript:" id="search-form" class="search-form min--260">
                            ...
                            <div class="input-group input--group">
                                <input id="datatableSearch_" type="search" name="search" class="form-control" placeholder="{{translate('messages.ex_search_order_id')}}" aria-label="{{translate('messages.search')}}" required>
