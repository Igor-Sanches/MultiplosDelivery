        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/star.png')}}" class="w--26" alt="">
                </span>
                <span>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="media align-items-center" href="{{route('vendor.item.view',[$review->item['id']])}}">
                                    <img class="avatar avatar-lg mr-3" src="{{my_asset('storage/app/public/product')}}/{{$review->item['image']}}"
                                        onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" alt="{{$review->item->name}} image">
