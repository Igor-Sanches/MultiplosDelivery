                        ...
                        <tr>
                            ...
                            <td>
                                <div class="overflow-hidden">
                                    <img class="img--vertical max--200 mw--200" src="{{my_asset('storage/app/public/campaign')}}/{{$campaign['image']}}"onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'">
                                </div>
                            </td>
                            <td>
