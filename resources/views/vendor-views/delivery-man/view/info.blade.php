        ...
        <div class="row mb-3 g-3 justify-content-center">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="resturant-card card--bg-1">
                    ...
                    <img class="resturant-icon w--30" src="{{my_asset('assets/admin/img/tick.png')}}" alt="img">
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="resturant-card card--bg-2">
                    ...
                    <img class="resturant-icon w--30" src="{{my_asset('assets/admin/img/withdraw-amount.png')}}" alt="img">
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="resturant-card card--bg-3">
                    ...
                    <img class="resturant-icon w--30" src="{{my_asset('assets/admin/img/pending.png')}}" alt="img">
                </div>
            </div>
                ...
                <div class="search--button-wrapper justify-content-end">
                    ...
                    <form action="javascript:" id="search-form" class="search-form">
                        ...
                        <div class="input-group input--group">
                            <input id="datatableSearch_" type="search" name="search" class="form-control" placeholder="{{translate('messages.ex_search_here')}}" aria-label="Search">
                        ...
                        <tr>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-circle">
                                            <img class="avatar-img" width="75" height="75"
                                                onerror="this.src='{{my_asset('assets/admin/img/160x160/img1.jpg')}}'"
                                                src="{{my_asset('storage/app/public/profile/'.$review->customer->image)}}"
                                                alt="Image Description">
                                        </div>
                                        <div class="ml-3">
                            ...
                            <td>
                                @foreach(json_decode($review['attachment'],true) as $attachment)
                                    <img width="100" onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'" src="{{my_asset('storage/app/public')}}/{{$attachment}}">
                                @endforeach
                            </td>
                            <td>
