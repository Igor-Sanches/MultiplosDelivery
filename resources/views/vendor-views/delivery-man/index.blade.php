        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/deliveryman.png')}}" class="w--30" alt="">
                </span>
                <span>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column">
                            <center class="my-auto py-3">
                                <img class="img--100" id="viewer" src="{{my_asset('assets/admin/img/400x400/img2.jpg')}}" alt="delivery-man image"/>
                            </center>
