...
@push('css_or_js')
    <link rel="stylesheet" href="{{my_asset('/assets/admin/css/intlTelInput.css')}}" />
@endpush
                            ...
                            <div class="form-group">
                                <div class="btn--container" id="coba">
                                    @foreach(json_decode($delivery_man['identity_image'],true) as $img)
                                        <div>
                                            <img class="img--120" src="{{my_asset('storage/app/public/delivery-man').'/'.$img}}">
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="my-auto">
                                <center class="pt-3">
                                    <img class="img--120" id="viewer"
                                        src="{{my_asset('storage/app/public/delivery-man').'/'.$delivery_man['image']}}" alt="delivery-man image"/>
                                </center>
                            </div>
...
<script src="{{my_asset('/assets/admin/js/intlTelInput.js')}}"></script>
<script src="{{my_asset('/assets/admin/js/intlTelInput-jquery.min.js')}}"></script>
<link rel="shortcut icon" href="{{my_asset('/assets/admin/img/flags.png')}}" type="image/x-icon">
<link rel="shortcut icon" href="{{my_asset('/assets/admin/img/flags@2x.png')}}" type="image/x-icon">
...
<script>
    ...
    <script>
        ...
        var phone = $("#phone").intlTelInput({
            utilsScript: "{{my_asset('/assets/admin/js/utils.js')}}",
            nationalMode: true,
    ...
    <script>
        ...
        //     $('#viewer').attr('src','{{my_asset('storage/app/public/delivery-man').'/'.$delivery_man['image']}}');
