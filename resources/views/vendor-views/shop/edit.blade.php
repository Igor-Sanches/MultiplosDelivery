...
@push('css_or_js')
    ...
    <link href="{{my_asset('assets/admin')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
     <!-- Custom styles for this page -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <center class="my-auto py-4 py-xl-5">
                                ...
                                onerror="this.src='{{my_asset('assets/admin/img/image-place-holder.png')}}'"
                                src="{{my_asset('storage/app/public/store/'.$shop->logo)}}" alt="Product thumbnail"/>
                            </center>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-column pt-0">
                            <center class="my-auto py-4 py-xl-5">
                                ...
                                onerror="this.src='{{my_asset('assets/admin/img/restaurant_cover.jpg')}}'"
                                src="{{my_asset('storage/app/public/store/cover/'.$shop->cover_photo)}}" alt="Product thumbnail"/>
                            </center>
                            <div class="custom-file">
