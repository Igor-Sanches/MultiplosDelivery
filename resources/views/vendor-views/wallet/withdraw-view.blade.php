...
@push('css_or_js')
    ...
    <link href="{{my_asset('assets')}}/vendor/datatables/dataTables.bootstrap4.min.css" rel="stylesheet">
    <link href="{{my_asset('assets/css/croppie.css')}}" rel="stylesheet">
...
@push('script')
    <!-- Page level plugins -->
    <script src="{{my_asset('assets')}}/vendor/datatables/jquery.dataTables.min.js"></script>
    <script src="{{my_asset('assets')}}/vendor/datatables/dataTables.bootstrap4.min.js"></script>
