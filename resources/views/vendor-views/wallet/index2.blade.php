                ...
                <div class="card h-100 card--bg-1">
                    <div class="card-body text-center d-flex flex-column justify-content-center align-items-center">
                        ...
                        <div class="d-flex align-items-center justify-content-center mt-3">
                            ...
                            <img src="{{my_asset('assets/admin/img/cash.png')}}" alt="img">
                        </div>
                ...
                <div class="row g-2">
                    ...
                    <div class="col-sm-6">
                        <div class="resturant-card card--bg-2" >
                            ...
                            <img class="resturant-icon w--30" src="{{my_asset('/assets/admin/img/transactions/pending.png')}}" alt="transaction">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="resturant-card card--bg-3">
                            ...
                            <img class="resturant-icon w--30" src="{{my_asset('/assets/admin/img/transactions/withdraw-amount.png')}}" alt="transaction">
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                        <div class="resturant-card card--bg-1">
                            ...
                            <img class="resturant-icon w--30" src="{{my_asset('/assets/admin/img/transactions/earning.png')}}" alt="transaction">
                        </div>
                    </div>
                </div>
