        ...
        <div class="page-header">
            <h1 class="page-header-title">
                <span class="page-header-icon">
                    <img src="{{my_asset('assets/admin/img/categories.png')}}" class="w--20" alt="">
                </span>
                <span>
                        ...
                        <div class="search--button-wrapper justify-content-end">
                            <form action="javascript:;" id="search-form" class="search-form min--280">
                                ...
                                <div class="input-group input--group">
                                    <input id="datatableSearch" type="search" name="search" class="form-control" placeholder="{{translate('messages.ex_search_sub_category')}}" aria-label="{{translate('messages.search_here')}}">
