    ...
    <div class="row g-2">
        ...
        <div class="col-md-4 col-6">
            <div class="grid-card top--rated-food pb-4 cursor-pointer" onclick="location.href='{{route('vendor.item.view',[$item['id']])}}'">
                <center>
                    <img class="rounded" src="{{my_asset('storage/app/public/product')}}/{{$item['image']}}" onerror="this.src='{{my_asset('assets/admin/img/100x100/2.png')}}'" alt="{{Str::limit($item->name??translate('messages.Item deleted!'),20,'...')}}">
                </center>
