                ...
                <div class="card __card mb-3">
                    ...
                    <div class="card-body p-4">
                        <div class="row row-margin-top">
                            ...
                            <div hidden class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <img class="__register-img" id="logoImageViewer"
                                        src="{{ my_asset('assets/admin/img/160x160/img1.jpg') }}"
                                        alt="Product thumbnail" />
                        ...
                        <div class="row row-margin-top">
                            ...
                            <div class="col-md-12 col-lg-12 col-sm-12 mb-3">
                                ...
                                <div id="map"></div>
{{--                                <a class="btn btn-soft-success btn-success" onclick="goLocalization()">Pegar Minha Localização</a>--}}
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
