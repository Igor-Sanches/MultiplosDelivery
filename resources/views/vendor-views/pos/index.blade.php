                                    ...
                                    <div class="col-sm-6">
                                        <form id="search-form" class="search-form m-0">
                                            ...
                                            <div class="input-group input--group">
                                                <input id="datatableSearch" type="search" value="{{$keyword?$keyword:''}}" name="search" class="form-control h--45px" placeholder="{{translate('messages.ex_search_here')}}" aria-label="{{translate('messages.search_here')}}">
