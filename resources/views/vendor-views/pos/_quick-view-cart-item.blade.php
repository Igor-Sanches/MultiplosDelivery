...
<div class="modal-body">
    <div class="d-flex flex-row align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-center active h-9rem">
            <img class="img-responsive img-responsive-1"src="{{my_asset('storage/app/public/product')}}/{{$product['image']}}"
                onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'"
                    data-zoom="{{my_asset('storage/app/public/product')}}/{{$product['image']}}"
