...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{my_asset('storage/app/public/business/'.$logo??'')}}">
    <!-- Font -->
    ...
    <ul class="main-menu">
        ...
        <li>
            <a class="p-2 navbar-dropdown-account-wrapper" href="javascript:;" onclick="set_filter('{{url()->full()}}',{{$module->id}},'module_id')" title="{{$module->module_name}}">
                <img class="avatar avatar-sm avatar-circle" src="{{my_asset('storage/app/public/module')}}/{{$module['thumbnail']}}" alt="{{$module->module_name}}" width="20">
            </a>
        </li>
        @endforeach
        <li>
            <a class="p-2 navbar-dropdown-account-wrapper" href="javascript:;" onclick="set_filter('{{url()->full()}}','','module_id')" title="{{$module->module_name}}">
                <img class="avatar avatar-sm avatar-circle" src="{{my_asset('storage/app/public/business/'.$logo??'')}}" alt="{{translate('messages.all')}} {{translate('messages.module')}}" width="20">
            </a>
        </li>
    </ul>
...
@stack('script_2')
<audio id="myAudio">
    <source src="{{my_asset('assets/admin/sound/notification.mp3')}}" type="audio/mpeg">
</audio>
