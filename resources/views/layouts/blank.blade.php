        ...
        <div class="col-md-12">
            <div id="loading" class="initial-hidden">
                <div class="loading-inner">
                    <img width="200" src="{{my_asset('assets/front-end/img/loader.gif')}}">
                </div>
            </div>
        </div>
    </div>
...
{{--<script src="{{my_asset('assets/front-end')}}/vendor/jquery/dist/jquery.slim.min.js"></script>--}}
<script src="{{my_asset('assets/admin')}}/js/demo.js"></script>
