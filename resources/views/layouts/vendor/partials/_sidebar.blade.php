        ...
        <div class="navbar-vertical-container">
            <div class="navbar-brand-wrapper justify-content-between">
                ...
                <a class="navbar-brand" href="{{route('vendor.dashboard')}}" aria-label="Front">
                    <img class="navbar-brand-logo initial--36" onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'"
                         src="{{my_asset('storage/app/public/store/'.$store_data->logo)}}" alt="Logo">
                    <img class="navbar-brand-logo-mini initial--36" onerror="this.src='{{my_asset('assets/admin/img/160x160/img2.jpg')}}'"
                         src="{{my_asset('storage/app/public/store/'.$store_data->logo)}}" alt="Logo">
                </a>
                <!-- End Logo -->
            ...
            <div class="navbar-vertical-content text-capitalize bg--005555" id="navbar-vertical-content">
                ...
                <!-- End DeliveryMan -->
                    ...
                    @endif
                    <li class="navbar-vertical-aside-has-menu {{ Request::is('vendor-panel/invoices/list') ? 'active' : '' }}">
                        <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{ route('vendor.invoices.list') }}" title="{{ translate('messages.invoices') }}">
