...
<head>
    ...
    <link rel="stylesheet" href="{{ my_asset('assets/landing/css/bootstrap.min.css') }}" />
    <link rel="stylesheet" href="{{ my_asset('assets/landing/css/customize-animate.css') }}" />
    <link rel="stylesheet" href="{{ my_asset('assets/landing/css/odometer.css') }}" />
    <link rel="stylesheet" href="{{ my_asset('assets/landing/css/owl.min.css') }}" />
    <link rel="stylesheet" href="{{ my_asset('assets/admin/css/toastr.css') }}">
    <link rel="stylesheet" href="{{ my_asset('assets/landing/css/main.css') }}"/>

    @php($icon = \App\Models\BusinessSetting::where(['key' => 'icon'])->first()->value ?? '')
    <link rel="icon" type="image/x-icon" href="{{ my_asset('storage/app/public/business/' . $icon ?? my_asset('assets/landing/img/favicon.svg')) }}">
    @stack('css_or_js')
            ...
            <div class="navbar-bottom-wrapper">
                ...
                <a href="{{route('home')}}" class="logo">
                    <img
                        ...
                        src="{{ my_asset('storage/app/public/business/' . $fav) }}" alt="">
                </a>
                ...
                @if ($toggle_dm_registration || $toggle_store_registration)
                    <div class="position-relative">
                        <a class="dropdown--btn header--btn text-capitalize" href="javascript:void(0)">
                            <span class="me-1">@lang('messages.join_us')</span>
            ...
            <div class="newsletter-wrapper">
                <div class="newsletter-content position-relative">
                    ...
                    <form method="post" action="{{route('newsletter.subscribe')}}">
                        @csrf
                        <div class="input--grp">
                            <input type="email" name="email" required class="form-control" placeholder="@lang('messages.enter_your_email_address')">
            ...
            <div class="footer-wrapper ps-xl-5">
                <div class="footer-widget">
                    <div class="footer-logo">
                        <a class="logo">
                            <img onerror="this.src='{{ my_asset('assets/admin/img/160x160/img2.jpg') }}'"
                                 src="{{ my_asset('storage/app/public/business/' . $logo) }}" alt="">
                        </a>
                    </div>
                    <div class="txt">
                            ...
                            @foreach ($social_media as $social)
                                <li>
                                    <a href="{{ $social->link }}" target="_blank">
                                        <img src="{{ my_asset('assets/landing/img/footer/'. $social->name.'.svg') }}" alt="">
                                    </a>
                                </li>
                            @endforeach
                        @endif
                        ...
                        <div class="app-btn-grp">
                            @if (isset($landing_page_links['app_url_android_status']))
                                <a href="{{ isset($landing_page_links['app_url_ios']) ? $landing_page_links['app_url_ios'] : '' }}">
                                    <img src="{{ my_asset('assets/landing/img/google.svg') }}" alt="">
                                </a>
                            @endif
                            @if (isset($landing_page_links['app_url_ios_status']))
                                <a href="{{ isset($landing_page_links['app_url_android']) ? $landing_page_links['app_url_android'] : '' }}">
                                    <img src="{{ my_asset('assets/landing/img/apple.svg') }}" alt="">
                                </a>
                            @endif
                        </div>
                    @endif
                ...
                <div class="footer-widget widget-links">
                    <h5 class="subtitle mt-2 text-white">{{translate("messages.Contact")}}</h5>
                    <ul>
                        <li>
                            <a>
...
<!-- ======= Footer Section ======= -->
<script src="{{ my_asset('assets/landing/js/jquery-3.6.0.min.js') }}"></script>
<script src="{{ my_asset('assets/landing/js/bootstrap.min.js') }}"></script>
<script src="{{ my_asset('assets/landing/js/viewport.jquery.js') }}"></script>
<script src="{{ my_asset('assets/landing/js/wow.min.js') }}"></script>
<script src="{{ my_asset('assets/landing/js/odometer.min.js') }}"></script>
<script src="{{ my_asset('assets/landing/js/owl.min.js') }}"></script>
<script src="{{ my_asset('assets/landing/js/main.js') }}"></script>
