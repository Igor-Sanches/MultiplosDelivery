...
<body style="background-color: #ececec;">
  ...
  <div style="width:595px;margin:auto; background-color:white;
      ...
      <div style="display:block;">
        <img src="{{my_asset('/storage/app/public/business/'.$logo)}}" alt="{{$company_name}}" style="height: 15px; width:auto;">
      </div>

      <img src="{{my_asset('assets/admin/img/tick.png')}}" style="height: 50px; width:50px; margin-top:40px;">
