            ...
            <tr>
                ...
                <td>
                    <div style="text-align: right; margin-right:15px;">
                        <img style="max-width:250px;border:0;" src="{{my_asset('/storage/app/public/business/'.$logo)}}" title=""
                    ...
                    <div style="text-align:left;margin-top:10px;">
                      ...
                      @if ($order->restaurant)
                        ...
                        <div style="display:flex; align-items:center;margin-top:10px;">
                            ...
                            <img style="border:0;border-radius:50%;" src="{{my_asset('/storage/app/public/restaurant/'.$order->restaurant->logo)}}" title=""
                ...
                @if(isset($social_media))
                    <th style="width: 100%;">
                        ...
                        <div style="display:inline-block;">
                            ...
                            <img src="{{my_asset('assets/admin/img/'.$item->name.'.png')}}" alt="" style="height: 14px; width:14px; padding: 0px 3px 0px 5px;">
                            </a>
                        </div>
                        @endforeach
                    </th>
