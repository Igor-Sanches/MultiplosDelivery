            ...
            <tr>
                ...
                <td>
                    <div style="text-align: right; margin-right:15px;">
                        <img class="w-100" onerror="this.src='{{ my_asset('assets/admin/img/160x160/img2.jpg') }}'"
                    ...
                    <th style="width: 100%;">
                        ...
                        <div style="display:inline-block;">
                            <a href="{{$item->link}}" target=”_blank”>
                                <img src="{{ my_asset('assets/landing/img/footer/'. $item->name.'.svg') }}"  style="height: 14px; width:14px; padding: 0px 3px 0px 5px;" alt="">
                            </a>
                        </div>
                        @endforeach
                    </th>
