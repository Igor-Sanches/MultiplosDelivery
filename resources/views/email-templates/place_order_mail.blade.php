                    ...
                    <td>
                        <div style="text-align: right; margin-right:15px;">
                            <img style="max-width:250px;border:0;"
                                src="{{ my_asset('/storage/app/public/business/' . $logo) }}" title=""
                                ...
                                @if ($order->store)
                                    <div style="display:flex; align-items:center;margin-top:10px;">
                                        <img style="border:0;border-radius:50%;"
                                            src="{{ my_asset('/storage/app/public/store/' . $order->store->logo) }}" title="Logo"
                            ...
                            @foreach ($social_media as $social)
                                <div style="display:inline-block;">
                                    <a href="{{ $social->link }}" target=”_blank”>
                                        <img src="{{ my_asset('assets/admin/img/' . $social->name . '.png') }}"
