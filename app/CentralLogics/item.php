...
class ProductLogic
{
    ...
    public static function get_latest_products($zone_id, $limit, $offset, $store_id, $category_id, $type, $longitude, $latitude)
    {
        $paginator = Item::query()->active()
...
//        })
    ...
    public static function get_related_products($zone_id,$product_id, $longitude, $latitude)
    {
    ...
    public static function popular_products($zone_id, $longitude,$latitude, $limit = null, $offset = null, $type = 'all')
    {
    ...
    public static function most_reviewed_products($zone_id, $longitude, $latitude, $limit = null, $offset = null, $type = 'all')
    {
        if($limit != null && $offset != null)
        {
            $paginator = Item::query()
