...
{
    public function get_stores(Request $request, $filter_data="all"): JsonResponse
    {
    ...
    public function get_latest_stores(Request $request, $filter_data="all"): JsonResponse
    {
        if (!$request->hasHeader('zoneId')) {
            $errors = [];
            $errors[] = ['code' => 'zoneId', 'message' => translate('messages.zone_id_required')];
    ...
    public function get_popular_stores(Request $request): JsonResponse
    {
        if (!$request->hasHeader('zoneId')) {
            $errors = [];
    ...
    public function get_searched_stores(Request $request): JsonResponse
    {
        if (!$request->hasHeader('zoneId')) {
            $errors = [];
            $errors[] = ['code' => 'zoneId', 'message' => translate('messages.zone_id_required')];
