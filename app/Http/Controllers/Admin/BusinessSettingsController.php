...
class BusinessSettingsController extends Controller
{
    ...
    public function business_setup(Request $request)
    {
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'percentage_referral_bonus'], [
            'value' => $request['percentage_referral_bonus']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'money_referral_bonus'], [
            'value' => $request['money_referral_bonus']
        ]);

        DB::table('business_settings')->updateOrInsert(['key' => 'single_referral_bonus'], [
            'value' => $request['single_referral_bonus']
        ]);
        ...
        DB::table('business_settings')->updateOrInsert(['key' => 'cashback_default'], [
            'value' => $request['cashback_default']
        ]);
...
//        ]);
    ...
    public function payment_update(Request $request, $name)
    {
        ...
        } elseif ($name == 'payment_credit_card_offline') {
            $payment = BusinessSetting::where('key', 'payment_credit_card_offline')->first();
            if (isset($payment) == false) {
                DB::table('business_settings')->insert([
                    'key'        => 'payment_credit_card_offline',
                    'value'      => json_encode([
                        'status' => $request['status'],
                    ]),
                    'created_at' => now(),
                ...
                DB::table('business_settings')->where(['key' => 'payment_credit_card_offline'])->update([
                    'key'        => 'payment_credit_card_offline',
                    'value'      => json_encode([
                        'status' => $request['status'],
                    ]),
        ...
        } elseif ($name == 'payment_debit_card_offline') {
            $payment = BusinessSetting::where('key', 'payment_debit_card_offline')->first();
            if (isset($payment) == false) {
                DB::table('business_settings')->insert([
                    'key'        => 'payment_debit_card_offline',
                    'value'      => json_encode([
                        'status' => $request['status'],
                    ]),
                    'created_at' => now(),
                ...
                DB::table('business_settings')->where(['key' => 'payment_debit_card_offline'])->update([
                    'key'        => 'payment_debit_card_offline',
                    'value'      => json_encode([
                        'status' => $request['status'],
                    ]),
        ...
        } elseif ($name == 'payment_pix_offline') {
            $payment = BusinessSetting::where('key', 'payment_pix_offline')->first();
            if (isset($payment) == false) {
                DB::table('business_settings')->insert([
                    'key'        => 'payment_pix_offline',
                    'value'      => json_encode([
                        'status' => $request['status'],
                    ]),
                    'created_at' => now(),
                ...
                DB::table('business_settings')->where(['key' => 'payment_pix_offline'])->update([
                    'key'        => 'payment_pix_offline',
                    'value'      => json_encode([
                        'status' => $request['status'],
                    ]),
