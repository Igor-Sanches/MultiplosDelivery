...
class OrderController extends Controller
{
    ...
    public function status(Request $request)
    {
        ...
        if ($request->order_status == 'delivered' && $order['transaction_reference'] == null && !has_payment_offline($order['payment_method'])) {
        ...
        if ($request->order_status == 'delivered') {
            ...
            if ($order->transaction  == null) {
                if (has_payment_offline($order->payment_method)) {
            ...
            if ($order->payment_status == "paid" && $wallet_status == 1 && $refund_to_wallet == 1) {
                ...
                CustomerLogic::create_wallet_transaction($order->user_id, $refund_amount, 'order_refund', $order->id,$order->store->name, '');
