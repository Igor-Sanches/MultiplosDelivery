...
class ModuleController extends Controller
{
    ...
    {
        $modules = Module::query()->withCount('stores')->latest()->paginate(config('default_pagination'));
    ...
    public function edit($id)
    {
        ...
        $module = Module::query()->with('zones')->withoutGlobalScope('translate')->findOrFail($id);
