...
Route::group(['namespace' => 'Admin', 'as' => 'admin.'], function () {
    ...
    Route::group(['middleware' => ['admin']], function () {
        ...
        Route::group(['prefix' => 'invoices', 'as' => 'invoices.'], function (){
            Route::get('list', 'VendorController@list_invoices')->name('list');
            Route::post('finish-payment', 'VendorController@finish_payment')->name('finish-payment');
            Route::post('send-proof', 'VendorController@send_proof')->name('send-proof');
            Route::post('date-due', 'VendorController@date_due')->name('date-due');
            Route::get('print-invoice/{id}', 'VendorController@print_invoice')->name('print-invoice-2');
            Route::get('print-invoice-print/{id}', 'VendorController@print_invoice_print')->name('print-invoice');
            Route::get('deny-payment/{id}', 'VendorController@deny_payment')->name('deny-payment');
            Route::get('confirm-payment/{id}', 'VendorController@confirm_payment')->name('confirm-payment');
            Route::get('view-proof/{id}', 'VendorController@view_proof')->name('view-proof');
            Route::post('filter', 'VendorController@filter_invoices')->name('filter');
            Route::get('filter/reset', 'VendorController@filter_reset_invoices')->name('filter-reset');
            Route::post('filter-store', 'VendorController@filter_invoices_store')->name('filter-store');
            Route::get('filter-store/reset', 'VendorController@filter_reset_invoices_store')->name('filter-reset-store');
        });
        ...
        Route::group(['prefix' => 'store', 'as' => 'store.'], function () {
                ...
                Route::post('update/{store}', 'VendorController@update')->name('update');
                    ...
                    Route::post('consolidate-cycle/{store}', 'VendorController@consolidate_cycle')->name('consolidate-cycle');
                ...
                Route::post('update-setup-delivery-radius/{store}', 'VendorController@update_setup_delivery_radius')->name('update-setup-delivery-radius');
        ...
        Route::group(['prefix' => 'zone', 'as' => 'zone.', 'middleware' => ['module:zone']], function () {
            ...
            Route::get('edit-delivery-fee/{id}', 'ZoneController@edit_delivery_fee')->name('edit-delivery-fee');
            Route::post('store', 'ZoneController@store')->name('store');
            Route::post('update-delivery-fee', 'ZoneController@update_delivery_fee')->name('update-delivery-fee');
        ...
        Route::group(['prefix' => 'customer', 'as' => 'customer.', 'middleware' => ['module:customerList']], function () {
            ...
            Route::get('view/{tab}/{user_id}', 'CustomerController@view')->name('view');
            Route::get('address-edit/{id}/{address_id}', 'CustomerController@edit_address')->name('address-edit');
            Route::post('update-address-customer/{id}/{address_id}', 'CustomerController@update_address_customer')->name('update-address-customer');
            Route::get('edit-customer/{user_id}', 'CustomerController@edit_customer')->name('edit-customer');
            Route::post('update-customer/{user_id}', 'CustomerController@update_customer')->name('update-customer');
