...
Route::group(['namespace' => 'Vendor', 'as' => 'vendor.'], function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::group(['prefix' => 'invoices', 'as' => 'invoices.'], function (){
            Route::get('list', 'WalletController@list_invoices')->name('list');
            Route::post('filter', 'WalletController@filter_invoices')->name('filter');
            Route::get('filter/reset', 'WalletController@filter_reset_invoices')->name('filter-reset');
            Route::post('send-proof', 'WalletController@send_proof')->name('send-proof');
            Route::get('print-invoice/{id}', 'WalletController@print_invoice')->name('print-invoice-2');
            Route::get('print-invoice-print/{id}', 'WalletController@print_invoice_print')->name('print-invoice');
            Route::get('view-proof/{id}', 'WalletController@view_proof')->name('view-proof');
            Route::post('finish-payment', 'WalletController@finish_payment')->name('finish-payment');
        });
        ...
        Route::group(['prefix' => 'business-settings', 'as' => 'business-settings.', 'middleware' => ['module:store_setup']], function () {
            ...
            Route::post('update-setup-delivery-radius/{store}', 'BusinessSettingsController@update_setup_delivery_radius')->name('update-setup-delivery-radius');
