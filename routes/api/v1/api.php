...
|
*/
Route::get('get-stores', 'VendorController@get_stores_api');
...
Route::group(['namespace' => 'Api\V1', 'middleware'=>'localization'], function () {
    ...
    Route::group(['middleware'=>['module-check']], function(){
        Route::group(['prefix' => 'customer', 'middleware' => 'auth:api'], function () {
            ...
            Route::get('search-friend', [AffiliateController::class, 'search']);
            ...
            Route::group(['prefix'=>'wallet'], function() {
                ...
                Route::get('list-affiliate', [AffiliateController::class, 'affiliates']);
                Route::post('pay-friend', [AffiliateController::class, 'pay_friend']);
                Route::get('affiliate-info', [AffiliateController::class, 'affiliate_info']);
                Route::post('set-affiliate', [AffiliateController::class, 'set_affiliate']);
                Route::post('put-affiliate', [AffiliateController::class, 'put_affiliate']);
            });
        ...
        Route::group(['prefix' => 'categories'], function () {
            Route::get('/', 'CategoryController@get_categories');
            Route::get('subcategories', 'CategoryController@get_subcategories');
            Route::get('childes/{category_id}', 'CategoryController@get_childes');
