...
|
*/
Route::get('storage/app/public/{folder}/{subFolder}/{filename?}', [StorageController::class, 'storage']);
...
Route::get('/affiliate/{ref_code}', [AffiliateController::class, 'affiliate']);
Route::post('affiliate-connect/{payload}/{ref_code}', [AffiliateController::class, 'affiliate_connect'])->name('affiliate-connect');
